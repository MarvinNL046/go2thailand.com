      ...
      <div className="overflow-hidden bg-canvas text-charcoal">
        ...
        <section id="kiezen" className="section-divider-bottom scroll-mt-24 py-16 lg:py-24">
          <div className="container-custom grid gap-10 lg:grid-cols-[1.04fr_0.96fr] lg:items-center">
            ...
            <div>
              <SectionHeading eyebrow="Scan voordat je bestelt" title="Een kraam is pas interessant als hij jouw vraag oplost" description={<>Voor gerecht- en ingrediëntcontext lees je onze <InlineLink href="/food/">Thaise streetfoodgids</InlineLink>. Hier draait het om kiezen binnen een venue waar het aanbod per shift roteert.</>} />
        ...
        <section id="vergelijken" className="section-divider-bottom scroll-mt-24 bg-tonal py-16 lg:py-24">
          <div className="container-custom">
            <div className="grid gap-10 lg:grid-cols-[0.62fr_1.38fr] lg:items-end">
              <SectionHeading eyebrow="Kies de setting" title="Wanneer Lumpini wel — en wanneer niet" description={<>Wil je juist avondmarkten met winkelen en meer omwegen, vergelijk dan onze <InlineLink href="/blog/night-markets-food-lovers-bangkok-chiang-mai-phuket/">Bangkokse nachtmarkten</InlineLink>. Lumpini wint vooral als park en eten samen je dag vereenvoudigen.</>} />
        ...
        <RelatedGuidesSection
          ...
          guides={[
            { title: 'Bangkok streetfood', description: 'Leer bestellen, kiezen en allergenen bespreken buiten één hawker centre.', href: '/food/', image: '/images/blog/thai-street-food-guide-2026.webp' },
            ...
            { title: 'Nachtmarkten vergelijken', description: 'Kies een avondmarkt wanneer eten, winkelen en sfeer samen belangrijker zijn.', href: '/blog/night-markets-food-lovers-bangkok-chiang-mai-phuket/', image: '/images/blog/best-night-markets-bangkok-2026.webp' },
          ]}
        />
