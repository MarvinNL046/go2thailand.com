      ...
      <main className="overflow-hidden bg-canvas text-charcoal">
        ...
        <RelatedGuidesSection
          ...
          guides={[
            ...
            { title: 'Bangkok streetfood', description: 'Koppel je ochtendkoffie aan een maaltijd en gebruik dezelfde nuchtere selectiechecks.', href: '/blog/thai-street-food-guide-2026/', image: '/images/blog/thai-street-food-guide-2026.webp' },
