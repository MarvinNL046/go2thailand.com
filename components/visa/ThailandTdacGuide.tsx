      ...
      <div className="bg-canvas text-charcoal">
        ...
        <RelatedGuidesSection
          ...
          guides={[
            ...
            { title: 'Eerste keer Thailand', description: 'Een rustige beslisvolgorde van route tot aankomst.', href: '/thailand-for-first-timers/', image: '/images/redesign/thailand-tdac-hero.webp', imageAlt: 'Eerste reis naar Thailand' },
          ]}
        />
