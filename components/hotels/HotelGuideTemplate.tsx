    ...
    <>
      ...
      <div className="bg-canvas text-charcoal">
        <EditorialHero
          ...
          gradientClassName={
            data.citySlug === 'hat-yai' || data.citySlug === 'sukhothai' || data.citySlug === 'surat-thani' || data.citySlug === 'chumphon' || data.citySlug === 'nakhon-si-thammarat'
