          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-4 flex flex-col justify-between flex-1 min-w-0">
                <div>
                  <span className="inline-block bg-[#2D2A4A] text-white text-xs font-medium px-2 py-0.5 rounded-full capitalize mb-2">
                    {post.category}
                  </span>
                  <h3 className="font-bold text-gray-900 group-hover:text-[#2D2A4A] transition-colors line-clamp-2 text-base leading-snug">
                    {post.title}
                  </h3>
