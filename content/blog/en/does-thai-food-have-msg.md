---
title: "Does Thai Food Have MSG? What You Should Know"
slug: "does-thai-food-have-msg"
date: "2026-03-21"
author:
  name: "Go2Thailand Team"
category: "food"
tags: ["thai food", "MSG", "food safety", "thailand dining"]
image: "/images/blog/does-thai-food-have-msg.webp"
description: "Yes, MSG (phong chu rot) is commonly used in Thai cooking. Learn why, whether it's safe, and how to request no MSG when ordering food in Thailand."
featured: false
readingTime: 5
...
sources:
  ...
  - name: "PMC - Review of Alleged Health Hazards of MSG"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC6952072/"
  - name: "Taste of Thailand - Does Thai Food Have MSG?"
    url: "https://tasteofthailand.co.uk/does-thai-food-have-msg/"
---
...
- **U.S. Food and Drug Administration (FDA):** MSG is classified as **"Generally Recognized as Safe" (GRAS)** -- the same category as salt, sugar, and vinegar. The FDA has required MSG to be listed on food labels since 1969.

- **World Health Organization (WHO) and FAO:** The Joint Expert Committee on Food Additives (JECFA) has reviewed MSG multiple times and found it safe for the general population. They established an acceptable daily intake but noted that normal dietary consumption falls well within safe limits.

- **European Food Safety Authority (EFSA):** In 2017, EFSA set a safe intake level of **30 mg per kilogram of body weight per day**, which for an average adult translates to about 2 grams daily -- far more than a typical meal contains.
...
**Does street food in Thailand always have MSG?**
Most vendors use it, but not all. If you ask "mai sai phong chu rot," they will typically leave it out. Check our guide on [eating like a local in Thailand for under $5](/blog/eat-like-local-thailand-under-5-dollars/) for more ordering tips.

**Is MSG the same as salt?**
No. MSG contains about **one-third the sodium** of table salt. Some cooks use it specifically to add umami while using less salt overall.

**Do Thai restaurants outside Thailand use MSG?**
Many do, though an increasing number advertise "no MSG" in response to customer preferences, compensating with extra fish sauce or mushroom powder. If you have other dietary concerns, see our guides on [is Thai food gluten-free](/blog/is-thai-food-gluten-free/), [is Thai food healthy](/blog/is-thai-food-healthy/), and [halal food in Thailand](/blog/halal-food-thailand-guide/).
...
No. While MSG is common in street food stalls and local restaurants, many higher-end restaurants advertise "no MSG" cooking. Health-conscious vendors in [Bangkok](/city/bangkok/food/) and [Chiang Mai](/city/chiang-mai/food/) sometimes skip it as well. Jay (vegan) restaurants also tend to avoid it. If you want to explore the food scene further, a [cooking class in Bangkok](/blog/best-cooking-classes-bangkok-market-tour-2026/) or [Chiang Mai](/blog/thai-cooking-classes-chiang-mai/) is a great way to see exactly what goes into each dish.
