...
image: /images/blog/bangkok-airport-transfer-guide-2026.webp
sources:
...
faq:
  - question: "What is the cheapest way from Bangkok airport to the city?"
    answer: "The Airport Rail Link from Suvarnabhumi (BKK) to Phaya Thai costs just 45 THB ($1.30) and takes 26 minutes. From Don Mueang (DMK), the A1 public bus to Mo Chit BTS is 30 THB ($0.90). Neither runs overnight, so arrivals after 00:00 need a taxi or Grab."
  - question: "Is Grab cheaper than a metered taxi in Bangkok?"
    answer: "No, a metered taxi is usually 30 to 40 percent cheaper than Grab for the same ride. A BKK to Sukhumvit taxi with the 50 THB airport surcharge runs 300 to 450 THB, while Grab charges 400 to 650 THB. Grab wins on predictability, English-speaking interface and no haggling, which is why most tourists still prefer it."
  - question: "How do I use the Airport Rail Link from Suvarnabhumi?"
    answer: "Follow signs to the basement (B floor) of the main terminal, buy a plastic token from the vending machines or counter (45 THB to Phaya Thai), tap in at the gate, and board. Trains run every 10 to 15 minutes between roughly 05:30 and 24:00. Phaya Thai connects to the BTS Skytrain for onward travel."
  - question: "What are my options from Don Mueang (DMK) to Bangkok?"
    answer: "Don Mueang has no train link. Your options are the A1 public bus to Mo Chit (30 THB), the limousine counter (around 1,000 THB), a metered taxi (200 to 400 THB plus 50 THB surcharge), or Grab (around 300 to 500 THB). The A1 bus is fastest in light traffic and runs every 5 minutes."
  - question: "Is it worth pre-booking an airport transfer for Bangkok?"
    answer: "Pre-booking is worth it for late-night arrivals, families with kids, groups of three or more, or anyone heading straight to Pattaya or Hua Hin. For a solo traveler arriving during the day and going to Sukhumvit, the Airport Rail Link or a metered taxi is cheaper and just as easy. Pre-booked transfers via Klook run 600 to 1,000 THB."
  - question: "What are the most common Bangkok airport taxi scams?"
    answer: "The big three are the 'broken meter' (driver refuses to use it and quotes a flat 800 to 1,500 THB), the 'closed hotel' scam (driver claims your hotel burned down and takes you to a kickback partner), and the 'short trip to a gem shop' detour. Always insist on the meter, ignore anyone offering rides inside the terminal, and only use the Public Taxi Queue stand on Level 1."
  - question: "What transport is available at Bangkok airports at night?"
    answer: "BKK has 24 hour metered taxis from the Public Taxi Queue and 24 hour Grab pickup. DMK also has round-the-clock taxis and Grab. The Airport Rail Link (BKK) and A1 bus (DMK) stop around midnight and restart around 05:30. Late-night Grab surge pricing can add 20 to 50 percent, so a metered taxi is often the best value after 23:00."
  - question: "How do I travel between Suvarnabhumi (BKK) and Don Mueang (DMK)?"
    answer: "The free airline shuttle bus runs between terminals roughly every 30 minutes from 05:00 to 24:00 and takes about 60 to 90 minutes with traffic. You need a same-day boarding pass or ticket to board for free. A taxi costs around 800 THB ($25) and takes 45 to 70 minutes. Always allow a minimum 4 hour layover if switching airports."
---

Landing in Bangkok tired, jet-lagged and dragging a suitcase is the worst moment to figure out transport. Touts will circle you before you clear customs, taxi drivers will insist their meter is broken, and the "helpful" man in the lobby offering a ride is almost certainly a commission scammer. This guide gives you the real 2026 prices, the exact walking directions for each option, and the scams to shut down fast. Read it on the plane and you will walk out of arrivals knowing exactly what to do.
...
**BKK to Sukhumvit (Asok, Nana, Ekkamai)**: 400 to 550 THB
**BKK to Silom or Sathorn**: 450 to 600 THB
**BKK to Khao San Road**: 500 to 650 THB
...
Book a private transfer in advance through [Klook](https://www.klook.com/en-SG/activity/1555-suvarnabhumi-airport-transfer-bangkok/) or [GetYourGuide](https://www.getyourguide.com/bangkok-l169/) and a driver meets you at Arrivals holding a sign with your name. Prices typically run **600 to 1,000 THB ($18 to $29)** for a sedan, 1,200 to 1,800 THB for a van (up to 8 passengers with luggage).
