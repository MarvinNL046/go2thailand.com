...
export const chiangMaiDestinationGuideEn: DestinationGuideData = {
  ...
  planning: {
    weather: { title: "Season matters, live air matters more", summary: "The generally cooler months are popular for outdoor days. The hot season and periods of regional haze can change visibility and comfort; wetter months bring greener landscapes and showers.", best: "Common first-trip window: roughly November–February", tradeoff: "No month guarantees clear air. Check live AQI, the forecast and official warnings, and be willing to move a mountain day.", href: "/city/chiang-mai/weather/", image: "/images/cities/chiang-mai/redesign/chiang-mai-weather-hero.webp", imageAlt: "Chiang Mai temple and mountain under changing seasonal sky" },
