...
export const kohMakIslandGuide: DestinationGuideData = {
  ...
  relatedGuides: [
    ...
    { title: 'Koh Kood', description: 'Vergelijk een groter en groener buureiland met andere transfers en verblijfafstanden.', href: '/city/trat/attractions/', image: '/images/blog/koh-kood-quiet-island-guide-trat-2026.webp', imageAlt: 'Groene kust en helder water bij Koh Kood' },
  ],
  sources: [
