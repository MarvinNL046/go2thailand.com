...
export const kohPhiPhiIslandGuide: DestinationGuideData = {
  ...
  relatedGuides: [
    { title: 'Phi Phi-tour vergelijken', description: 'Bekijk actuele vertrekpunten en tourvoorwaarden wanneer je niet op het eiland verblijft.', href: '/phi-phi-island-tour/', image: '/images/blog/phi-phi-islands-guide-beyond-tourist-crowds.webp', imageAlt: 'Boottocht door het landschap van de Phi Phi-eilanden' },
