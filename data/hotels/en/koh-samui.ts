...
export const kohSamuiHotelGuideEn: HotelGuideData = {
  citySlug: "koh-samui",
  cityName: "Koh Samui",
  parentGuideHref: "/city/koh-samui/",
  locale: "en",
  pageTitle: "Best Hotels in Koh Samui: 8 Verified Picks",
  pageDescription:
    "Compare 8 Koh Samui hotels by coast, beach access and honest trade-offs. See verified details and check current Trip.com prices.",
  pageUrl: "https://go2-thailand.com/best-hotels/koh-samui/",
  heroImage: "/images/redesign/best-hotels-koh-samui-en-hero.webp",
  heroAlt:
    "Refined tropical resort and infinity pool above a calm granite-fringed Koh Samui bay",
  eyebrow: "Eight stays, six different island rhythms",
  heroTitle: "Best hotels",
  heroAccent: "in Koh Samui",
  intro:
  ...
  areas: [
    {
      slug: "chaweng",
      name: "Chaweng & North Chaweng",
      shortLabel: "Maximum convenience",
      tone: "easy",
      image: "/images/redesign/koh-samui-stay-chaweng.webp",
      imageAlt:
        "Chaweng Beach at blue hour with restaurants and walkers beside the sea",
      bestFor:
    ...
    },
    {
      ...
      shortLabel: "Calm near the airport",
      tone: "quiet",
      image: "/images/redesign/koh-samui-stay-choeng-mon.webp",
      imageAlt:
        "Sheltered Choeng Mon bay with calm water and low-rise tropical resorts",
      bestFor:
    ...
    {
      slug: "bophut-bang-rak",
      name: "Bophut & Bang Rak",
      shortLabel: "Evenings & connections",
      tone: "local",
      image: "/images/redesign/koh-samui-fishermans-village.webp",
      imageAlt:
        "Warm evening lights and historic shopfronts in Fisherman's Village Bophut",
      bestFor:
    ...
    {
      slug: "lamai",
      name: "Lamai & the southeast coves",
      shortLabel: "Beach-town balance",
      tone: "scenic",
      image: "/images/redesign/koh-samui-stay-lamai.webp",
      imageAlt:
        "Lamai Beach with palms, calm sea and small-scale hotels along the shore",
      bestFor:
    ...
    {
      slug: "northwest",
      name: "Maenam, Bang Por & the northwest",
      shortLabel: "Space & slow days",
      tone: "quiet",
      image: "/images/redesign/koh-samui-stay-maenam.webp",
      imageAlt:
        "Spacious palm-fringed north-coast beach near Maenam and Bang Por",
      bestFor:
    ...
    {
      slug: "taling-ngam",
      name: "Taling Ngam & the southwest",
      shortLabel: "Sunset isolation",
      tone: "scenic",
      image: "/images/redesign/koh-samui-stay-taling-ngam.webp",
      imageAlt:
        "Golden sunset over the quiet southwest Koh Samui coast at Taling Ngam",
      bestFor:
  ...
  hotelPicks: [
    {
      name: "Lub d Koh Samui Chaweng Beach",
      area: "Central Chaweng",
      category: "Best social base",
      bestFor:
      ...
      whySelected:
        "It represents Samui's social-budget end without disguising its personality. Travellers seeking early quiet nights should treat the organised party atmosphere as a real trade-off.",
      officialUrl: "https://lubd.com/destination/koh-samui/",
    },
    {
      name: "Hyatt Regency Koh Samui",
      area: "North Chaweng",
      category: "Best close-airport resort",
      bestFor:
      ...
      whySelected:
        "It adds a full-service northeast resort to the shortlist. Its rocky coastal setting and North Chaweng position are not the same as walking out into central Chaweng Beach Road.",
      officialUrl:
        "https://www.hyatt.com/hyatt-regency/en-US/usmrk-hyatt-regency-koh-samui",
    },
    {
      name: "Kimpton Kitalay Samui",
      area: "Choeng Mon",
      category: "Best design-led family calm",
      bestFor:
      ...
      whySelected:
        "It makes Choeng Mon's quiet-near-the-airport proposition concrete. The trade-off is a resort-led evening rather than Bophut's or Chaweng's breadth outside the gate.",
      officialUrl:
        "https://www.ihg.com/kimptonhotels/hotels/us/en/koh-samui/usmkm/hoteldetail",
    },
    {
      name: "Karma Resort",
      area: "Bophut Beach",
      category: "Best small Bophut stay",
      bestFor:
      ...
      whySelected:
        "It gives Bophut an intimate design-led counterpoint to the large resorts. Verify the exact walk to the part of Fisherman's Village you plan to use rather than assuming every Bophut address is central.",
      officialUrl: "https://www.karma-resort.com/",
    },
    {
      name: "Prana Resort Nandana",
      area: "Bang Rak",
      category: "Best practical north-coast link",
      bestFor:
      ...
      whySelected:
        "Its Bang Rak position supports practical arrival and northern connections. The split-wing layout and busy coastal road deserve checking when choosing a room and daily walking route.",
      officialUrl: "https://pranaresorts.com/koh-samui-nandana/",
    },
    {
      name: "Banyan Tree Samui",
      area: "Lamai headland",
      category: "Best private-bay pool villas",
      bestFor:
      ...
      whySelected:
        "It shows how a Lamai address can mean secluded headland rather than walkable town. Budget for vehicles whenever central Lamai or Chaweng forms part of the plan.",
      officialUrl: "https://www.banyantree.com/thailand/samui",
    },
    {
      name: "Four Seasons Resort Koh Samui",
      area: "Ang Thong, northwest coast",
      category: "Best northwest villa retreat",
      bestFor:
      ...
      whySelected:
        "Its villa-and-residence range makes a remote northwest stay workable for different group sizes. The official location guidance puts the airport around 20 kilometres away, so this is not a spontaneous nightlife base.",
      officialUrl: "https://www.fourseasons.com/kohsamui/",
    },
    {
      name: "Conrad Koh Samui",
      area: "Taling Ngam",
      category: "Best southwest sunset stay",
      bestFor:
      ...
      whySelected:
        "It is the clearest sunset-and-isolation choice in this list. The same geography makes repeated Chaweng or Bophut trips inefficient, so on-site time must be intentional.",
      officialUrl: "https://www.hilton.com/en/hotels/usmksci-conrad-koh-samui/",
    },
  ],
  splitStay: {
    eyebrow: "One coast or two?",
    title: "Move only when the second coast changes the trip",
    description:
  ...
  bookingTips: [
    ...
    {
      title: "Compare equal conditions",
      description:
  ...
  specialistGuides: [
    {
      ...
      description:
        "Separate genuine direct sand access from a rocky coast, road crossing or near-beach address.",
      href: "/best-hotels/koh-samui/beachfront/",
    },
    {
      title: "Boutique hotels",
      description:
        "Compare smaller character-led stays around Bophut, Lamai and quieter coves.",
      href: "/best-hotels/koh-samui/boutique/",
    },
    {
      title: "Budget hotels",
      description:
        "Protect location and transport convenience while reducing the final room total.",
      href: "/best-hotels/koh-samui/budget/",
    },
    {
      title: "Hotels for couples",
      description:
        "Choose between walkable evenings, private coves and sunset-led pool-villa stays.",
      href: "/best-hotels/koh-samui/couples/",
    },
    {
      title: "Family hotels",
      description:
        "Compare room fit, pools, kids facilities, easy meals and low-friction transfers.",
      href: "/best-hotels/koh-samui/family/",
    },
    {
      title: "Luxury hotels",
      description:
        "Go deeper on private bays, pool villas, large resorts and deliberately remote coasts.",
      href: "/best-hotels/koh-samui/luxury/",
    },
    {
      title: "Mid-range hotels",
      description:
        "Find the useful middle between a simple room and a stay built around the resort.",
      href: "/best-hotels/koh-samui/mid-range/",
    },
  ],
  profileLinks: [
    {
      title: "Complete Koh Samui travel guide",
      href: "/guides/travel-guide/koh-samui/",
    },
    { title: "Baan Talay Resort", href: "/hotel/baan-talay-resort/" },
    { title: "Banyan Tree Samui", href: "/hotel/banyan-tree-samui/" },
    { title: "Conrad Koh Samui", href: "/hotel/conrad-koh-samui/" },
    {
      title: "Four Seasons Resort Koh Samui",
      href: "/hotel/four-seasons-resort-koh-samui/",
    },
    {
      title: "Hyatt Regency Koh Samui",
      href: "/hotel/hyatt-regency-koh-samui/",
    },
    { title: "Karma Resort", href: "/hotel/karma-resort/" },
    {
      title: "Kimpton Kitalay Samui",
      href: "/hotel/kimpton-kitalay-samui/",
    },
    {
      title: "Lub d Koh Samui Chaweng Beach",
      href: "/hotel/lub-d-koh-samui-chaweng-beach/",
    },
    { title: "Prana Resort Samui", href: "/hotel/prana-resort-samui/" },
    { title: "Samui Hostel", href: "/hotel/samui-hostel/" },
    { title: "Six Senses Samui", href: "/hotel/six-senses-samui/" },
    {
      title: "Zazen Boutique Resort & Spa",
      href: "/hotel/zazen-boutique-resort-spa/",
    },
  ],
  faqs: [
    {
    ...
    {
      question: "Is it better to stay in Chaweng or Lamai?",
      answer:
    ...
    {
      question: "Should I stay in Bophut or Lamai?",
      answer:
    ...
    {
      question: "Which part of Koh Samui has the best beaches?",
      answer:
    ...
    {
      question: "Which Koh Samui hotels are best for families?",
      answer:
    ...
    {
      question: "Is a beachfront hotel in Koh Samui always worth it?",
      answer:
    ...
    {
      question: "How many days do you need in Koh Samui?",
      answer:
    ...
    {
      question: "Which months should you avoid Koh Samui?",
      answer:
  ...
  relatedGuides: [
    {
      ...
      description:
        "Build the complete island plan around beaches, temples, transfers and realistic travel time.",
      href: "/city/koh-samui/",
      image: "/images/redesign/koh-samui-destination-hero.webp",
    },
    {
      title: "Where to stay in Koh Samui",
      description:
        "Compare the island's coasts in depth before choosing an individual property.",
      href: "/where-to-stay/koh-samui/",
  ...
  sources: [
    {
      title: "Koh Samui destination information",
      creator: "Tourism Authority of Thailand",
      url: "https://www.tourismthailand.org/Destinations/Provinces/Ko-Samui/360",
      note: "Official island context for beaches, settlements and destination planning.",
    },
    {
      title: "Samui Airport",
      creator: "Bangkok Airways / Samui Airport",
      url: "https://www.samuiairport.com/en/",
      note: "Official airport information for current arrival and departure planning.",
    },
    {
      title: "Lub d Koh Samui Chaweng Beach",
      creator: "Lub d",
      url: "https://lubd.com/destination/koh-samui/",
      note: "Current room types, social positioning, Chaweng identity and on-site events.",
    },
    {
      title: "Hyatt Regency Koh Samui",
      creator: "Hyatt",
      url: "https://www.hyatt.com/hyatt-regency/en-US/usmrk-hyatt-regency-koh-samui",
      note: "Current North Chaweng address, coastal setting, rooms, pools and family facilities.",
    },
    {
      title: "Kimpton Kitalay Samui",
      creator: "IHG / Kimpton",
      url: "https://www.ihg.com/kimptonhotels/hotels/us/en/koh-samui/usmkm/hoteldetail",
      note: "Current address, accommodation range, kids club, pools and dining.",
    },
    {
      title: "Karma Resort",
      creator: "Karma Resort",
      url: "https://www.karma-resort.com/",
      note: "Current Bophut location, room and villa positioning, beach, pool restaurant and spa.",
    },
    {
      title: "Prana Resort Nandana",
      creator: "Prana Hotels & Resorts",
      url: "https://pranaresorts.com/koh-samui-nandana/",
      note: "Current Bang Rak address, two-wing layout, room categories, pools, spa and dining.",
    },
    {
      title: "Banyan Tree Samui",
      creator: "Banyan Group",
      url: "https://www.banyantree.com/thailand/samui",
      note: "Current Lamai private-bay location, all-pool-villa format, beach, spa and dining.",
    },
    {
      title: "Four Seasons Resort Koh Samui",
      creator: "Four Seasons Hotels and Resorts",
      url: "https://www.fourseasons.com/kohsamui/",
      note: "Current Ang Thong address, northwest setting, villas, residences, beach and family facilities.",
    },
    {
      title: "Conrad Koh Samui",
      creator: "Hilton / Conrad",
      url: "https://www.hilton.com/en/hotels/usmksci-conrad-koh-samui/",
      note: "Current southwest hillside setting, pool-villa format, Gulf views, dining and spa.",
    },
  ],
