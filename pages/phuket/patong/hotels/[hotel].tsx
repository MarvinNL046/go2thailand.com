        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <section className="rounded-2xl bg-thailand-blue/10 p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              <a href={`https://12go.tpo.lv/3aLNBOQk?subid=other-pseo-phuket-patong-hotel-${hotel.slug}-airport-transfer`} target="_blank" rel="noopener noreferrer nofollow sponsored" className="rounded-full bg-thailand-blue text-white px-5 py-2 text-sm font-semibold hover:bg-blue-700">{isNl ? '🚐 Airport → Patong transfer' : '🚐 Airport → Patong transfer'}</a>
