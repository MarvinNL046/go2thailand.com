...
export default function PhuketNaiHarnPillarPage({ partners, lastUpdated }: Props) {
  ...
  if (!isNl) {
    return <NaiHarnAreaGuideEn hotelHref={partners.trip_pillar?.partnerUrl} activityHref={partners.klook_activities?.partnerUrl || partners.klook_pillar?.partnerUrl} />;
  }
