...
export default function PhuketWeddingVenuesPillar({
  partners,
  lastUpdated,
}: Props) {
  ...
  if (isNl) {
    return (
      <PhuketRomanceVillaGuideNl
        owner="wedding-hub"
        primaryUrl={partners.trip_wedding_venue.partnerUrl}
        ...
        <section className="bg-thailand-blue text-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href={withSubId(
                  partners.trip_wedding_venue.partnerUrl,
                  placement("hero-trip"),
                )}
                target="_blank"
              ...
              >
                {isNl
                  ? "Bekijk wedding-venues op Trip.com"
                  : "See wedding venues on Trip.com"}{" "}
                →
              </a>
              <a
                href={withSubId(
                  partners.trip_beach_resort.partnerUrl,
                  placement("hero-beach"),
                )}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
            ...
            <div className="mt-5 flex flex-wrap gap-x-5 gap-y-1 text-xs opacity-90">
              ...
              <span>
                ✔{" "}
                {isNl
                  ? "Pakket-prijzen + legal-info"
                  : "Package pricing + legal info"}
              </span>
              <span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <section id="comparison">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-2">
              {isNl
                ? "9 trouwlocaties Phuket vergeleken"
                : "9 Phuket wedding venues compared"}
            </h2>
            <p className="text-gray-600 mb-6">
              {isNl
                ? "Klik om live beschikbaarheid te zien (we verdienen een kleine commissie zonder dat het jou iets extra kost)."
              ...
              <table className="min-w-full text-sm">
                <thead className="bg-gray-50 text-gray-700">
                  <tr>
                    ...
                    <th className="text-left font-semibold px-4 py-3">
                      {isNl ? "Capaciteit" : "Capacity"}
                    </th>
                    <th className="text-left font-semibold px-4 py-3">
                      {isNl ? "Pakket vanaf" : "Package from"}
                    </th>
                    <th className="text-left font-semibold px-4 py-3">
                      {isNl ? "Boek" : "Book"}
                    </th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    {
                      name: "Amanpuri",
                      type: isNl ? "Pansea Beach" : "Pansea Beach",
                      cap: "20–80",
                      price: "$12,000",
                    },
                    {
                      name: "Banyan Tree",
                      type: isNl
                        ? "Lagune-villa, Bang Tao"
                        : "Lagoon villa, Bang Tao",
                      cap: "20–200",
                      price: "$4,500",
                    },
                    {
                      name: "The Slate",
                      type: isNl
                        ? "Beach + binnen, Nai Yang"
                        : "Beach + indoor, Nai Yang",
                      cap: "20–250",
                      price: "$3,200",
                    },
                    {
                      name: "JW Marriott Mai Khao",
                      type: isNl ? "Beach, Mai Khao" : "Beach, Mai Khao",
                      cap: "20–300",
                      price: "$3,800",
                    },
                    {
                      name: "Cape Sienna",
                      type: isNl ? "Heuveltop, Kamala" : "Hilltop, Kamala",
                      cap: "20–80",
                      price: "$2,800",
                    },
                    {
                      ...
                      type: isNl
                        ? "Privé-villa, Kamala"
                        : "Private villa, Kamala",
                      cap: "20–60",
                      price: "$3,500",
                    },
                    {
                      name: "The Surin",
                      type: isNl ? "Beach, Pansea" : "Beach, Pansea",
                      cap: "20–100",
                      price: "$4,200",
                    },
                  ].map((v, i) => (
          ...
          <section className="rounded-2xl bg-thailand-red/5 border-2 border-thailand-red p-6">
            ...
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-3">
              {isNl
                ? "Sri Panwa — heuveltop ceremonie + privacy"
                : "Sri Panwa — hilltop ceremony + privacy"}
            </h2>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                {isNl
                  ? "Bekijk Sri Panwa op Trip.com"
                  : "See Sri Panwa on Trip.com"}{" "}
                →
              </a>
              <a
                href={withSubId(
                  partners.trip_luxury_honeymoon.partnerUrl,
                  placement("toppick-luxury"),
                )}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
          ...
          <section>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "4 venue-types in Phuket — welke past?"
                : "4 venue types in Phuket — which fits?"}
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-blue-500">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  {isNl ? "🏖️ Strand-ceremonie" : "🏖️ Beach ceremony"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Klassieke Thailand-stijl, dramatische fotos. Privé resort-stranden (Trisara, Amanpuri, The Surin) houden vreemden weg — publiek strand kan willekeurige zonbaders in je fotos opleveren. Sand-aisle setup met petals + arch: $800–2.500. Backup-tent verplicht buiten droogseizoen."
                    : "Classic Thailand style, dramatic photos. Private resort beaches (Trisara, Amanpuri, The Surin) keep strangers out — public beach can mean random sunbathers in your photos. Sand-aisle setup with petals + arch: $800–2,500. Backup tent mandatory outside dry season."}
                </p>
                <Link
                  href="/phuket-wedding-venues/beach/"
                  className="inline-flex items-center mt-3 text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl
                    ? "Strand-trouwlocaties Phuket →"
                    : "Beach wedding venues Phuket →"}
                </Link>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-green-500">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  {isNl ? "🌳 Resort-tuin" : "🌳 Resort garden"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Betrouwbaarste regen-backup (covered pavilions), makkelijkste catering-flow, beste capaciteit voor 40+ gasten. JW Marriott Mai Khao, Banyan Tree en Sri Panwa hebben dedicated tuin-wedding-zones. Iets minder dramatisch dan strand of heuveltop maar veel hogere weather-zekerheid."
                    : "Most reliable rain backup (covered pavilions), easiest catering flow, best capacity for 40+ guests. JW Marriott Mai Khao, Banyan Tree and Sri Panwa have dedicated garden wedding zones. Slightly less dramatic than beach or hilltop but much higher weather certainty."}
                </p>
                <Link
                  href="/phuket-wedding-venues/resort-packages/"
                  className="inline-flex items-center mt-3 text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl
                    ? "Resort wedding-pakketten →"
                    : "Resort wedding packages →"}
                </Link>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-amber-500">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  {isNl ? "🏔️ Heuveltop-ceremonie" : "🏔️ Hilltop ceremony"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Onverslaanbaar zonsondergang-uitzicht. Sri Panwa (Cape Panwa), Cape Sienna (Kamala), Cape Yamu — alle drie cliffside met cap 30–80. Pas op voor wind: petals waaien weg, dunne sluiers spelen op. Vraag operator naar wind-shield-setup. Beste tijd: 16:00–17:30 ceremonie voor sunset-receptie."
                    : "Unbeatable sunset views. Sri Panwa (Cape Panwa), Cape Sienna (Kamala), Cape Yamu — all three cliffside, cap 30–80. Watch the wind: petals blow away, thin veils misbehave. Ask operators about wind-shield setups. Best timing: 16:00–17:30 ceremony for sunset reception."}
                </p>
                <Link
                  href="/phuket-wedding-venues/resort-packages/"
                  className="inline-flex items-center mt-3 text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl
                    ? "Resort hilltop-pakketten →"
                    : "Resort hilltop packages →"}
                </Link>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-purple-500">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Total privacy + multi-day events. Andara Resort, Villa Aye, Villa Padma — 5–10 slaapkamers, eigen kok, eigen pool. Werkt voor 20–60 gasten over meerdere dagen. Kost: $8.000–25.000/nacht voor de villa, plus catering, decor, planner. Kies dit als 30%+ van je gasten 3+ nachten blijft."
                    : "Total privacy + multi-day events. Andara Resort, Villa Aye, Villa Padma — 5–10 bedrooms, private chef, private pool. Works for 20–60 guests across several days. Cost: $8,000–25,000/night for the villa, plus catering, decor, planner. Pick this if 30%+ of guests stay 3+ nights."}
                </p>
                <Link
                  href="/phuket-wedding-venues/villa/"
                  className="inline-flex items-center mt-3 text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl ? "Privé-villa weddings →" : "Private villa weddings →"}
                </Link>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-2xl bg-amber-50 border border-amber-200 p-6">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "Boekingstips voor Phuket-weddings"
                : "Booking tips for Phuket weddings"}
            </h2>
            <ul className="space-y-3 text-gray-800">
              <li className="flex gap-3">
                ...
                <span>
                  <strong>
                    {isNl
                      ? "Boek 9–12 maanden vooruit voor hoogseizoen"
                      : "Book 9–12 months ahead for high season"}
                  </strong>
                  {isNl
                    ? ": Sri Panwa, Trisara, Amanpuri zit voor zaterdagen in nov–feb 12 maanden vooruit op slot."
                    : ": Sri Panwa, Trisara, Amanpuri are booked 12 months out for Saturday dates in Nov–Feb."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Doordeweeks bespaart 20–30%"
                      : "Weekday saves 20–30%"}
                  </strong>
                  {isNl
                    ? ". Dinsdag–donderdag-tarieven liggen vaak een derde lager dan zaterdag — én betere fotograaf-beschikbaarheid."
                    : ". Tuesday–Thursday rates are often a third below Saturday — and photographers are more available."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Vraag wat ÉCHT in pakket zit"
                      : "Ask what is REALLY in the package"}
                  </strong>
                  {isNl
                    ? ": decor (bloemen vs zijde?), foto-uren (2 vs 8?), catering-courses, dranken (vol-bar vs alleen wijn/bier?), MC, geluid, regen-backup. 80% van klachten: hidden upsells."
                    : ": decor (real flowers vs silk?), photo hours (2 vs 8?), catering courses, drinks (full bar vs only wine/beer?), MC, sound, rain backup. 80% of complaints: hidden upsells."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Legal paperwork apart regelen"
                      : "Handle legal paperwork separately"}
                  </strong>
                  {isNl
                    ? ": resort-pakketten dekken zelden Thai-registratie. Boek dat via gespecialiseerde planner ($400–800) of doe het in eigen land."
                    : ": resort packages rarely cover Thai registration. Book that via a specialised planner ($400–800) or do it back home."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Reken op 25–35% extra naast pakket"
                      : "Budget 25–35% on top of the package"}
                  </strong>
                  {isNl
                    ? " voor: bloemen-upgrade, premium-bar, fotograaf-uren, gasten-transport, hair/make-up trial."
                    : " for: flower upgrades, premium bar, photographer hours, guest transport, hair/makeup trials."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Reisverzekering checken"
                      : "Check travel insurance"}
                  </strong>
                  {isNl
                    ? ': specifieke "wedding cancellation" verzekering kost 4–7% van totaal-budget en dekt regen-cancel, ziekte, vendor-faillissement.'
                    : ': specific "wedding cancellation" insurance costs 4–7% of total budget and covers rain cancel, illness, vendor bankruptcy.'}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Plan een sunset cruise voor de gasten"
                      : "Plan a sunset cruise for guests"}
                  </strong>
                  {isNl
                    ? ": $40–80pp gedeeld of $400–800 privé. Werkt als welkomst-event of dag-na ontspanning."
                    : ": $40–80 pp shared or $400–800 private. Works as a welcome event or day-after wind-down."}
                </span>
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "Juridische eisen voor buitenlandse stellen"
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100 space-y-3 text-gray-700">
              <p>
                {isNl
                  ? "Een trouwerij in Phuket is symbolisch tot je het Thai-process doorloopt. Stappen:"
                  : "A Phuket wedding is symbolic until you complete the Thai legal process. Steps:"}
              </p>
              <ol className="list-decimal list-inside space-y-2 leading-relaxed">
                <li>
                  {isNl
                    ? "Statutory Declaration aan ambassade in Bangkok ($30–60 pp)."
                    : "Statutory Declaration at your embassy in Bangkok ($30–60 pp)."}
                </li>
                <li>
                  {isNl
                    ? "Vertaling naar Thai door geautoriseerd vertaalbureau ($30–80)."
                    : "Translation into Thai by an authorised translation agency ($30–80)."}
                </li>
                <li>
                  {isNl
                    ? "Certificering bij Ministerie van Buitenlandse Zaken (MFA) — 3–5 werkdagen."
                    : "Certification at the Ministry of Foreign Affairs (MFA) — 3–5 working days."}
                </li>
                <li>
                  {isNl
                    ? "Registratie bij elke amphur (districtskantoor) in Thailand — Phuket Town heeft een centrale."
                    : "Registration at any amphur (district office) in Thailand — Phuket Town has a central one."}
                </li>
                <li>
                  {isNl
                    ? "Internationale apostille terug in eigen land (kosten verschillen per land)."
                    : "International apostille back in your home country (cost varies by country)."}
                </li>
              </ol>
              <p className="text-sm text-gray-600 mt-3">
                {isNl
                  ? "Totale doorlooptijd: 5–10 werkdagen, totaal $400–800 via planner. Veel internationale stellen doen alleen het symbolische deel in Phuket en regelen de juridische registratie thuis."
                  : "Total turnaround: 5–10 working days, total $400–800 via planner. Many international couples do only the symbolic ceremony in Phuket and register legally back home."}
              </p>
            </div>
          </section>
          ...
          <section className="rounded-2xl bg-thailand-blue/10 p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              >
                {isNl ? "🏖️ Strand-trouwlocaties" : "🏖️ Beach wedding venues"}
              </Link>
              <Link
                href="/phuket-wedding-venues/villa/"
                className="rounded-full bg-white text-thailand-blue border border-thailand-blue px-5 py-2 text-sm font-semibold hover:bg-thailand-blue hover:text-white"
