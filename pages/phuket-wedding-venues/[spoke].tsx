...
const SPOKE_LABELS: Record<SpokeSlug, { en: string; nl: string }> = {
  ...
  "resort-packages": {
    en: "Resort wedding packages",
    nl: "Resort wedding-pakketten",
  },
  villa: { en: "Private villa weddings", nl: "Privé-villa weddings" },
};

export default function PhuketWeddingSpokePage({
  spoke,
  primaryUrl,
  secondaryUrl,
  partners,
  ...
  if (isNl) {
    const owners: Record<SpokeSlug, PhuketRomanceVillaOwner> = {
      beach: "wedding-beach",
      "resort-packages": "wedding-packages",
      villa: "wedding-villa",
    };
    return (
  ...
  const placement = (slot: string) =>
    `${subId}-pseo-phuket-wedding-${spoke}-${slot}`;

  const breadcrumbs = [
    { name: "Home", href: "/" },
    {
      name: isNl ? "Phuket trouwlocaties" : "Phuket Wedding Venues",
      href: "/phuket-wedding-venues/",
    },
    {
      name: isNl ? SPOKE_LABELS[spoke].nl : SPOKE_LABELS[spoke].en,
      href: `/phuket-wedding-venues/${spoke}/`,
    },
  ];
  ...
  if (spoke === "beach") {
    ...
    descEn =
      "Looking for a beach wedding venue in Phuket? Compare 7 private-beach resorts (Trisara, Amanpuri, The Surin), packages $2,800–12,000 + tips.";
    descNl =
      "Op zoek naar een strand-trouwlocatie in Phuket? Vergelijk 7 privé-strand resorts (Trisara, Amanpuri, The Surin), pakketten $2.800–12.000.";
    ...
    descEn =
      "Looking for Phuket resort wedding packages? Compare 6 all-inclusive deals (Banyan Tree, JW Marriott, Sri Panwa) from $2,800 to $15,000+.";
    descNl =
      "Op zoek naar Phuket resort wedding-pakketten? Vergelijk 6 all-inclusive deals (Banyan Tree, JW Marriott, Sri Panwa) van $2.800 tot $15.000+.";
    ...
    descEn =
      "Looking for a private villa wedding in Phuket? Compare 5 multi-day takeover venues (Andara, Villa Aye, Padma) for 20–60 guests $8K–25K/night.";
    descNl =
      "Op zoek naar privé-villa bruiloft Phuket? Vergelijk 5 multi-day takeover venues (Andara, Villa Aye, Padma) voor 20–60 gasten $8K–25K/nacht.";
  ...
  const heroStats = (() => {
    if (spoke === "beach") {
      return [
        ...
        {
          label: isNl ? "Backup-tent" : "Backup tent",
          value: isNl ? "Aanbevolen" : "Recommended",
        },
      ];
    }
    if (spoke === "resort-packages") {
      return [
        {
          label: isNl ? "Pakket-tier" : "Package tier",
          value: "6 " + (isNl ? "opties" : "options"),
        },
  ...
  const tableRows = (() => {
    if (spoke === "beach") {
      return [
        {
          label: "Trisara (Layan)",
          spec: isNl ? "300m privé strand" : "300m private beach",
          price: "$7,500+",
          best: isNl ? "Iconic luxe ceremonie" : "Iconic luxury ceremony",
        },
        {
          label: "Amanpuri (Pansea)",
          spec: isNl ? "Privé bay, 40 villa's" : "Private bay, 40 villas",
          price: "$12,000+",
          best: isNl ? "Klein, sereen, exclusief" : "Small, serene, exclusive",
        },
        {
          label: "The Surin (Pansea)",
          spec: isNl ? "125m privé strand" : "125m private beach",
          price: "$4,200+",
          best: isNl ? "Mid-luxe, sterk eten" : "Mid-luxury, strong dining",
        },
        {
          label: "JW Marriott Mai Khao",
          spec: isNl ? "11km onbebouwd strand" : "11km undeveloped beach",
          price: "$3,800+",
          best: isNl ? "Grote groepen 100+" : "Large groups 100+",
        },
        {
          label: "The Slate (Nai Yang)",
          spec: isNl ? "Boutique design strand" : "Boutique design beach",
          price: "$3,200+",
          best: isNl ? "Indoor + outdoor flex" : "Indoor + outdoor flex",
        },
        {
          label: "Banyan Tree (Bang Tao)",
          spec: isNl ? "Lagune + strand" : "Lagoon + beach",
          price: "$4,500+",
          best: isNl ? "Spa-resort vibe" : "Spa-resort vibe",
        },
        {
          label: "Anantara Mai Khao",
          spec: isNl ? "Quiet 8km beach" : "Quiet 8km beach",
          price: "$3,500+",
          best: isNl ? "Stelletjes en kleine groep" : "Couples + small groups",
        },
      ];
    }
    if (spoke === "resort-packages") {
      return [
        {
          label: "Sri Panwa (cliffside)",
          spec: isNl ? "20–150 gasten" : "20–150 guests",
          price: "$5,500+",
          best: isNl ? "Heuveltop sunset" : "Hilltop sunset",
        },
        {
          label: "Trisara (beach + tuin)",
          spec: isNl ? "20–120 gasten" : "20–120 guests",
          price: "$7,500+",
          best: isNl ? "Iconic luxe" : "Iconic luxury",
        },
        {
          label: "Banyan Tree (lagune)",
          spec: isNl ? "20–200 gasten" : "20–200 guests",
          price: "$4,500+",
          best: isNl ? "Spa-resort all-in" : "Spa-resort all-in",
        },
        {
          label: "JW Marriott Mai Khao",
          spec: isNl ? "20–300 gasten" : "20–300 guests",
          price: "$3,800+",
          best: isNl ? "Grootste capaciteit" : "Largest capacity",
        },
        {
          label: "The Slate (Nai Yang)",
          spec: isNl ? "20–250 gasten" : "20–250 guests",
          price: "$3,200+",
          best: isNl ? "Boutique design" : "Boutique design",
        },
        {
          label: "Cape Sienna (Kamala)",
          spec: isNl ? "20–80 gasten" : "20–80 guests",
          price: "$2,800+",
          best: isNl ? "Mid-budget cliffside" : "Mid-budget cliffside",
        },
      ];
    }
    return [
      {
        label: "Andara Resort (Kamala)",
        spec: isNl ? "5–9 slk's, 20–60 gasten" : "5–9 br, 20–60 guests",
        price: "$8,000–18,000/n",
        best: isNl ? "Resort-services + privé" : "Resort services + private",
      },
      {
        label: "Villa Aye (Kamala)",
        spec: isNl ? "6 slk's, 12 gasten verblijf" : "6 br, 12 guest stay",
        price: "$3,500–8,500/n",
        best: isNl ? "Hilltop privé takeover" : "Hilltop private takeover",
      },
      {
        label: "Villa Padma (Kamala)",
        spec: isNl ? "6 slk's, oceaanview" : "6 br, ocean view",
        price: "$4,500–10,000/n",
        best: isNl ? "Cliffside grote events" : "Cliffside large events",
      },
      {
        label: "Sava Beach Villas (Natai)",
        spec: isNl ? "4–7 slk's, beachfront" : "4–7 br, beachfront",
        price: "$3,000–9,500/n",
        best: isNl ? "Multi-villa estate" : "Multi-villa estate",
      },
      {
        label: "Villa Amanzi (Kata Noi)",
        spec: isNl ? "6 slk's, dramatic view" : "6 br, dramatic view",
        price: "$5,500–12,500/n",
        best: isNl ? "Iconic photo-fame" : "Iconic photo fame",
      },
    ];
  })();
  ...
  const sections = (() => {
    if (spoke === "beach") {
      return [
        {
          title: isNl
            ? "Privé strand vs publiek strand — groot verschil"
            : "Private beach vs public beach — big difference",
          body: isNl
        ...
        {
          title: isNl
            ? "Wat zit er in een strand-pakket?"
            : "What's in a beach wedding package?",
          body: isNl
        ...
        {
          title: isNl
            ? "Beste tijd op de dag voor strand-ceremonie"
            : "Best time of day for a beach ceremony",
          body: isNl
    ...
    if (spoke === "resort-packages") {
      return [
        {
          title: isNl
            ? "Pakket-tiers: $2.800 vs $7.500 vs $15.000+"
            : "Package tiers: $2,800 vs $7,500 vs $15,000+",
          body: isNl
        ...
        {
          title: isNl
            ? "Onderhandelen werkt — waar precies"
            : "Negotiation works — exactly where",
          body: isNl
    ...
    return [
      {
        title: isNl
          ? "Waarom een privé-villa nemen"
          : "Why pick a private villa",
        body: isNl
      ...
      {
        title: isNl
          ? "Wat je écht uitgeeft (totaal)"
          : "What you actually spend (total)",
        body: isNl
      ...
      {
        title: isNl
          ? "Permits + nood-paperwork"
          : "Permits + nuts-and-bolts paperwork",
        body: isNl
  ...
  const tips = (() => {
    if (spoke === "beach") {
      return [
        {
          strong: isNl ? "Tij + zons-stand check" : "Tide + sun-angle check",
          body: isNl
            ? "— laag tij = bredere strand-setup, hoog tij = water dichter bij ceremonie. Sunset-ceremonie 1u voor zonsondergang voor golden hour."
            : "— low tide = wider beach setup, high tide = water closer to ceremony. Sunset ceremony 1h before sunset for golden hour.",
        },
        {
          strong: isNl
            ? "Backup-tent verplicht apr–nov"
            : "Backup tent mandatory Apr–Nov",
          body: isNl
            ? ". $500–1.500 voor een goede covered structure. Niet boeken = je viert binnen in een resort-zaal als het regent."
            : ". $500–1,500 for a good covered structure. Skip it = you celebrate indoors in a resort hall if it rains.",
        },
        {
          strong: isNl ? "Sand-floor schoenwerk" : "Sand-floor footwear",
          body: isNl
            ? "— communiceer met gasten: blote voeten of strand-sandalen. Hakken zinken weg, ruïneren je foto-line-up."
            : "— tell guests: bare feet or beach sandals. Heels sink in, ruin your photo line-up.",
        },
        {
          strong: isNl
            ? "Geluid op het strand is moeilijk"
            : "Sound on the beach is tricky",
          body: isNl
            ? "— wind + golfgeluid maakt vows-microfoon kritisch. Vraag operator om lavalier-microfoon plus speakers van topkwaliteit."
            : "— wind + wave noise makes vow-microphone critical. Ask operator for lavalier mics and top-quality speakers.",
        },
        {
          strong: isNl ? "Gasten-comfort eerst" : "Guest comfort first",
          body: isNl
            ? ": water-stations, parasols, koele handdoeken bij aankomst, sun-screen station. Een 30-min ceremonie in de zon zonder dit = klagende gasten op de fotos."
            : ": water stations, parasols, cool towels on arrival, sunscreen station. A 30-min ceremony in the sun without this = unhappy guests in your photos.",
        },
        {
          strong: isNl
            ? "Vrijdag/zaterdag uitverkocht"
            : "Friday/Saturday sells out",
          body: isNl
            ? "— top-resorts (Trisara, Amanpuri) verkopen 12 maanden vooruit. Doordeweeks (di-do) bespaart 20–30% en geeft fotograaf-keuze."
            : "— top resorts (Trisara, Amanpuri) sell 12 months out. Weekday (Tue-Thu) saves 20–30% and frees up photographer choice.",
        },
      ];
    }
    if (spoke === "resort-packages") {
      return [
        {
          strong: isNl
            ? "Vraag complete breakdown"
            : "Ask for the complete breakdown",
          body: isNl
            ? '— pakket "vanaf $4.500" zegt niks. Vraag: wat zit erin, wat is min-spend, welke uren foto, welke bar-niveau, hoeveel gasten max.'
            : '— "from $4,500" tells you nothing. Ask: what is included, what is the min-spend, photo hours, bar tier, max guests.',
        },
        {
          strong: isNl ? "Onderhandel kamer-block" : "Negotiate room block",
          body: isNl
            ? "— bij 10+ kamers, vraag 10–20% korting + late-release voorwaarde 60 dagen vóór. Resort wint cash, jij wint flexibel."
            : "— at 10+ rooms ask for 10–20% off + 60-day late-release clause. Resort wins cash, you win flexibility.",
        },
        {
          strong: isNl
            ? "Doordeweekse weddings 25% goedkoper"
            : "Weekday weddings 25% cheaper",
          body: isNl
            ? "— di–do prijslijsten zijn vaak een kwart lager dan zaterdag. Combineer met off-peak (april) voor max-savings."
            : "— Tue–Thu price lists are often a quarter below Saturday. Combine with off-peak (April) for max savings.",
        },
        {
          strong: isNl
            ? "Resort wedding-coordinator vs externe planner"
            : "Resort coordinator vs outside planner",
          body: isNl
            ? "— resort-coördinator zit in pakket maar werkt alleen ter plekke. Externe planner ($1.500–4.500) regelt vendors, paperwork, gasten-comms tussen reserveren en aankomst."
            : "— resort coordinator is in the package but only works on-site. Outside planner ($1,500–4,500) handles vendors, paperwork, guest comms between booking and arrival.",
        },
        {
          strong: isNl ? "Min-spend trucs" : "Watch for min-spend tricks",
          body: isNl
            ? '— "pakket $4.500" maar min food&drinks-spend $7.500. Dit verandert je werkelijke min-uitgave naar $12.000+. Vraag expliciet naar F&B-minimum.'
            : '— "package $4,500" but min food&drinks spend $7,500. Real minimum becomes $12,000+. Always ask about F&B minimum.',
        },
        {
          strong: isNl
            ? "Vendor-kostenpercentage check"
            : "Vendor cost share check",
          body: isNl
            ? "— sommige resorts rekenen 15–25% commissie als je externe vendors meebrengt. Sri Panwa, Trisara doen dit niet, JW Marriott wel. Vraag vooraf."
            : "— some resorts charge 15–25% commission for outside vendors. Sri Panwa and Trisara do not, JW Marriott does. Ask up-front.",
        },
        {
          strong: isNl
            ? "Reisverzekering met wedding-cancel-extensie"
            : "Wedding-cancel insurance",
          body: isNl
            ? "— 4–7% van budget. Dekt regen-cancel buiten droogseizoen, ziekte van bruidsstel, vendor-default."
            : "— 4–7% of budget. Covers rain cancel outside dry season, bridal party illness, vendor default.",
        },
      ];
    }
    return [
      {
        strong: isNl
          ? "Min 3 nachten — anders niet rendabel"
          : "Min 3 nights — anything less is not worth it",
        body: isNl
          ? ". Setup + breakdown van een grote villa-event kost een dag elk; 1–2 nachten = je bent vooral aan het op- en afbouwen."
          : ". Setup + breakdown of a large villa event eats a day each; 1–2 nights = you spend most of the stay assembling and dismantling.",
      },
      {
        strong: isNl
          ? "Catering apart van villa"
          : "Catering separate from villa",
        body: isNl
          ? "— villa's leveren keuken + service-staff, maar je catering komt van gespecialiseerde partners. Vraag villa-manager om 3 referenties."
          : "— villas provide kitchen + service staff, but catering comes from specialised partners. Ask villa manager for 3 references.",
      },
      {
        strong: isNl
          ? "Villa wedding-planner essentieel"
          : "Villa wedding planner essential",
        body: isNl
          ? "— resorts hebben in-huis coördinatoren, villa's niet. Externe planner ($3.000–8.000) regelt vendors, permits, timeline."
          : "— resorts have in-house coordinators, villas do not. Outside planner ($3,000–8,000) handles vendors, permits, timeline.",
      },
      {
        strong: isNl ? "Permits voor 50+ gasten" : "Permits for 50+ guests",
        body: isNl
          ? "— public event-permit nodig voor versterkte muziek na 22:00. $150–300 via planner. Niet hebben = politie sluit feest om 22:00."
          : "— public event permit needed for amplified music after 22:00. $150–300 via planner. Skip it = police shut down the party at 22:00.",
      },
      {
        strong: isNl
          ? "Schade-borg 5–10% van villa-prijs"
          : "Damage deposit 5–10% of villa price",
        body: isNl
          ? "— bevroren bij boeking, terug 7–14 dagen na vertrek. Pre-event walkthrough met manager + foto's om disputes te voorkomen."
          : "— frozen at booking, refunded 7–14 days after departure. Pre-event walkthrough with manager + photos to avoid disputes.",
      },
      {
        strong: isNl ? "Multi-villa-estate optie" : "Multi-villa estate option",
        body: isNl
          ? "— voor 40+ gasten: Sava Beach, Andara, Iniala. 3–8 villa's op één terrein. Cheaper per gast dan één mega-villa, plus iedereen krijgt eigen privacy."
          : "— for 40+ guests: Sava Beach, Andara, Iniala. 3–8 villas on one estate. Cheaper per guest than one mega-villa, and everyone gets their own privacy.",
      },
    ];
  })();
  ...
  const faqEn = (() => {
    ...
    if (spoke === "resort-packages") {
      return [
        ...
        {
          q: "Can we customise the Phuket resort wedding package?",
  ...
  const faqNl = (() => {
    if (spoke === "beach") {
      return [
        ...
        {
          q: "Beste Phuket-strand voor specifiek een trouw-ceremonie?",
    ...
    if (spoke === "resort-packages") {
      return [
        {
          q: 'Wat zit er écht in een Phuket "wedding packages resort" deal?',
          a: "Een typisch $4.500 resort wedding-pakket voor 40 gasten dekt: ceremonie-setup (decor, stoelen, arch), 3-gangen receptie-diner, basis-bloemarrangementen, 2-uur fotograaf, MC en geluid, bruidstaart, bruids hair/make-up. NIET inbegrepen: legal Thai paperwork ($400–800 apart), gasten-overnachting, alcohol buiten huiswijn/bier, foto-upgrades (4+ uur pakketten), pre-wedding photoshoot, transport tussen ceremonie en receptie. Vraag altijd om itemised PDF voor tekenen.",
        },
        {
          q: "Welk Phuket-resort heeft beste wedding-package value onder $5.000?",
          a: "Drie keuzes: Cape Sienna ($2.800+) — heuveltop ceremonie met sunset, 40-gasten cap, sterke foto-kwaliteit voor de prijs. The Slate ($3.200+) — boutique tin-mine design, indoor + outdoor flexibiliteit, grote gasten-capaciteit. Anantara Mai Khao ($3.500+) — rustiger strand, premium villa-stijl accommodatie voor bruidsgezelschap. Alle drie hebben ervaren English-speaking coordinators en standaard foto + decor — concurrerend in prijs zonder dunne pakketten.",
        },
        {
          q: "Hoeveel gasten passen op een typische Phuket resort-bruiloft?",
          a: "Standaard pakketten cap 40–80 gasten. Grotere venues (JW Marriott Mai Khao, Banyan Tree, Sri Panwa) doen 100–300 met toeslagen $80–150 pp. Ultra-luxe (Trisara, Amanpuri) prefereren intieme weddings — 60-cap is typisch, daarboven escaleren prijzen snel. Voor 100+: JW Marriott of Hilton Patong. Voor 200+: praktisch alleen JW Marriott Mai Khao.",
        },
        {
          q: "Kunnen we het Phuket resort wedding-pakket aanpassen?",
          a: "Ja — elke venue accepteert aanpassing. Gangbare upgrades: echte-bloem-arch ($500–2.000 over zijde), live-muziek/strijkkwartet ($600–1.800), foto-extensie ($300/uur), open-bar premium ($30–60 pp), late-night DJ ($800–2.000), themed decor. Laat opties uit pakket weg die je niet wilt — meeste resorts passen prijs aan voor ongebruikte items. Onderhandel op F&B-minimum, niet op foto of decor (markup-zwaar).",
        },
        {
    ...
    return [
      {
        q: "Waarom $40.000+ betalen voor privé-villa-bruiloft als resort goedkoper is?",
        a: "Drie redenen: (1) Multi-day events — bruidsmeisjes-bonding, rehearsal dinner, ceremonie, brunch alles op één plek over 3–7 dagen. (2) Totale privacy — geen andere gasten, geen hotel-personeel in fotos, geen tijd-restricties op muziek. (3) Bruidsgezelschap blijft samen — geen verspreide hotel-kamers. Per-gast kosten ($2.500–3.700) hoog vs resort ($1.500–2.500), maar ervaring fundamenteel anders. Kies villa als 30%+ van gasten 3+ nachten blijft; resort als gasten 1–2 nachten vliegen.",
      },
      {
        q: "Hoeveel slaapkamers nodig voor 30-gasten villa-bruiloft?",
        a: "Voor 30 gasten: 8–12 slaapkamers huisvesten iedereen behalve dag-trippers. Stellen delen meestal, kinderen in aangrenzende kamers. Multi-villa estates (Sava Beach Villas, Andara Resort, Iniala) bieden 2–4 villa's op één compound — lost capaciteit op zonder privacy te verliezen. Voor 50+ gasten: estate plus nabijgelegen resort voor overflow (10-kamer-block). Berekening: 30 gasten ÷ 2,5 gemiddeld per kamer = 12 kamers met buffer.",
      },
      {
        q: "Kunnen we eigen kok inhuren voor Phuket villa-bruiloft?",
        a: "Premium villa's (Sava Beach, Andara, Villa Padma) leveren keuken + service-staff maar catering komt van Thai food-safety-licensed bedrijf. Eigen kok van buiten kan technisch voor groepen onder 20, maar 30+ gasten vereist Thai-licensed kitchen-catering. Top villa-catering in Phuket: Diethelm Travel, The Phuket Catering Co, Coast Restaurant catering. Kosten: $150–350 pp voor full-day F&B (welkomst-cocktail, ceremony drinks, diner, late-night).",
      },
      {
        q: "Welke permits voor privé-villa-bruiloft in Phuket?",
      ...
      {
        q: "Beste privé-villa estates in Phuket voor weddings?",
        a: "Top 5: (1) Andara Resort (Kamala) — 5–9 slaapkamer-villa's met full resort-services, $8.000–18.000/n. (2) Sava Beach Villas (Natai, net noord van Phuket) — multi-villa beachfront estate, 4–7 SK elk, $3.000–9.500/n. (3) Iniala Beach House (Natai) — 3 villa's met privé-koks, $4.500–11.000/n. (4) Villa Aye (Kamala heuveltop) — 6 SK clifftop, $3.500–8.500/n. (5) Villa Padma (Kamala cliffside) — 6 SK oceaanview, $4.500–10.000/n. Boek 4–6 maanden vooruit voor hoogseizoen.",
      },
    ];
  })();
        ...
        <section className="bg-thailand-blue text-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href={withSubId(primaryUrl, placement("hero-primary"))}
                target="_blank"
              ...
              >
                {spoke === "beach" &&
                  (isNl
                    ? "Bekijk strand-resorts op Trip.com"
                    : "See beach resorts on Trip.com")}
                {spoke === "resort-packages" &&
                  (isNl
                    ? "Bekijk wedding-resorts op Trip.com"
                    : "See wedding resorts on Trip.com")}
                {spoke === "villa" &&
                  (isNl
                    ? "Bekijk privé-villa's op Trip.com"
                    : "See private villas on Trip.com")}{" "}
                →
              </a>
              <a
                href={withSubId(secondaryUrl, placement("hero-secondary"))}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
            ...
            <div className="mt-5 flex flex-wrap gap-x-5 gap-y-1 text-xs opacity-90">
              ...
              <span>
                ✔ {isNl ? "Eerlijke breakdowns" : "Honest breakdowns"}
              </span>
              <span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <section id="comparison">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-2">
              {spoke === "beach" &&
                (isNl
                  ? "Strand-trouwlocaties vergeleken"
                  : "Beach wedding venues compared")}
              {spoke === "resort-packages" &&
                (isNl
                  ? "Resort wedding-pakketten vergeleken"
                  : "Resort wedding packages compared")}
              {spoke === "villa" &&
                (isNl
                  ? "Privé-villa weddings vergeleken"
                  : "Private villa weddings compared")}
            </h2>
            <p className="text-gray-600 mb-6">
              {isNl
                ? "Klik om live tarieven te zien (we verdienen een kleine commissie zonder dat het jou iets extra kost)."
                : "Click to see live rates (we earn a small commission at no extra cost to you)."}
            </p>
            ...
            <p className="mt-3 text-xs text-gray-500">
              {isNl
                ? "Prijzen zijn 2026 hoogseizoen-tarieven (nov–feb). Buiten hoogseizoen 25–35% lager. F&B-minimum, gasten-overnachting en legal paperwork meestal apart."
                : "Prices are 2026 high-season rates (Nov–Feb). Outside high season 25–35% cheaper. F&B minimum, guest accommodation and legal paperwork usually separate."}
            </p>
          </section>
          ...
          <section className="rounded-2xl bg-thailand-red/5 border-2 border-thailand-red p-6">
            ...
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-3">
              {spoke === "beach" &&
                (isNl
                  ? "Trisara — privé Layan Beach + cliffside backup"
                  : "Trisara — private Layan Beach + cliffside backup")}
              {spoke === "resort-packages" &&
                (isNl
                  ? "Sri Panwa Hilltop pakket vanaf $5.500"
                  : "Sri Panwa hilltop package from $5,500")}
              {spoke === "villa" &&
                (isNl
                  ? "Andara Resort — multi-villa estate Kamala"
                  : "Andara Resort — multi-villa estate Kamala")}
            </h2>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href={withSubId(primaryUrl, placement("toppick-primary"))}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
              ...
              <a
                href={withSubId(secondaryUrl, placement("toppick-secondary"))}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
          ...
          <section className="rounded-2xl bg-amber-50 border border-amber-200 p-6">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {spoke === "beach" &&
                (isNl
                  ? "Boekingstips strand-trouwerij"
                  : "Booking tips for beach weddings")}
              {spoke === "resort-packages" &&
                (isNl
                  ? "Boekingstips resort-pakketten"
                  : "Booking tips for resort packages")}
              {spoke === "villa" &&
                (isNl
                  ? "Boekingstips privé-villa-bruiloft"
                  : "Booking tips for private villa weddings")}
            </h2>
          ...
          {siblings.length > 0 && (
            <section>
              <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
                {isNl
                  ? "Andere wedding-opties in Phuket"
                  : "Other wedding options in Phuket"}
              </h2>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {siblings.map((s) => (
                  <Link
                    key={s}
                    href={`/phuket-wedding-venues/${s}/`}
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      {s === "beach" &&
                        (isNl
                          ? "7 privé-strand resorts, $2.800–12.000+"
                          : "7 private-beach resorts, $2,800–12,000+")}
                      {s === "resort-packages" &&
                        (isNl
                          ? "6 all-inclusive deals, 20–300 gasten"
                          : "6 all-inclusive deals, 20–300 guests")}
                      {s === "villa" &&
                        (isNl
                          ? "5 multi-day takeover venues, 20–60 gasten"
                          : "5 multi-day takeover venues, 20–60 guests")}
                    </p>
          ...
          <section className="rounded-2xl bg-thailand-blue/10 p-6">
            <h2 className="font-heading text-xl font-bold text-gray-900">
              {isNl
                ? "Plan de rest van je Phuket trouwerij"
                : "Plan the rest of your Phuket wedding"}
            </h2>
            <p className="mt-2 text-gray-700">
              {isNl
                ? "Venue gekozen — werk de rest af:"
                : "Venue picked — wrap up the rest:"}
            </p>
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              >
                {isNl
                  ? "💒 Alle 9 trouwlocaties vergelijken"
                  : "💒 Compare all 9 wedding venues"}
              </Link>
              <Link
                href="/phuket-honeymoon/"
                className="rounded-full bg-thailand-red text-white px-5 py-2 text-sm font-semibold hover:bg-red-700"
              >
                {isNl
                  ? "💕 Honeymoon na de bruiloft"
              ...
              >
                {isNl ? "🏨 Hotels voor gasten" : "🏨 Hotels for guests"}
              </Link>
              <Link
              ...
              >
                {isNl
                  ? "⛵ Sunset cruise voor gasten"
                  : "⛵ Sunset cruise for guests"}
              </Link>
              <Link
              ...
              <a
                href={withSubId(GYG_GENERIC, placement("mesh-gyg"))}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
                className="rounded-full bg-thailand-red text-white px-5 py-2 text-sm font-semibold hover:bg-red-700"
              >
                {isNl
                  ? "🎟️ Pre-wedding activiteiten"
                  : "🎟️ Pre-wedding activities"}
              </a>
            </div>
          </section>
