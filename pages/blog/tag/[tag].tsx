...
import { strings as i18nStrings } from '../../../lib/i18n/blog-tag-tag';
      ...
      <div className="bg-surface-cream min-h-screen">
        <section className="bg-surface-dark text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <span className="font-script text-thailand-gold text-lg">Tagged</span>
            <h1 className="text-4xl font-bold font-heading">#{tag}</h1>
        ...
        <section className="py-8 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <TravelpayoutsRecoveryPanel
              pageType="blog"
              placement="blog-tag-recovery"
              category={posts[0]?.category}
              tags={[tag, ...posts.flatMap((post) => post.tags).slice(0, 9)]}
              columns={3}
            />
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {posts.length === 0 && (
              <div className="text-center py-12">
                <p className="text-gray-600">{t("s001_no_posts_found_with")}</p>
