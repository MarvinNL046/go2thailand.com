...
import { ThailandEsimProviderGuideEn } from "../../components/connectivity/ThailandEsimProviderGuideEn";
...
const comparisonRows = [
  {
    feature: "Best fit",
    airalo:
      "Short trips and travelers who want a widely used marketplace with several Thailand plan shapes.",
    yesim:
      "Heavier data use, unlimited-plan shoppers, or travelers who want the app and support layer to be a bigger part of the experience.",
    saily:
      "Travelers who want a straightforward data-only eSIM and value built-in privacy features in the app.",
  },
  {
  ...
  },
  {
    ...
    yesim:
      "Fixed plans, unlimited plans, and Pay & Fly options exist on the official site.",
  ...
  },
  {
    ...
    yesim:
      "Unlimited options, Pay & Fly, and 24/7 support messaging on the official site.",
...
export default function ESIMPage({ providers }: ESIMPageProps) {
  const siteLogoUrl =
    "https://go2-thailand.com/images/brand/go2thailand-logo-2026.png";
  const { locale } = useRouter();
  if (locale !== "nl") {
    return <ThailandEsimProviderGuideEn />;
  }
    ...
    <>
      ...
      <div className="bg-surface-cream min-h-screen">
          ...
          <div className="container-custom py-16">
            <div className="mx-auto max-w-4xl text-center">
              <p className="font-script text-thailand-gold mb-2">
                {t("Stay Connected", "Blijf Verbonden")}
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <div className="bg-white bg-opacity-20 px-4 py-2 rounded-full text-sm font-medium">
                  {t(
                    ...
                    `Voorbeeldprijzen gecontroleerd ${REVIEWED_DATE}`,
                  )}
                </div>
                <div className="bg-white bg-opacity-20 px-4 py-2 rounded-full text-sm font-medium">
                  {t(
                    "Data-only and unlimited options",
                    "Alleen data en onbeperkte opties",
                  )}
                </div>
                <div className="bg-white bg-opacity-20 px-4 py-2 rounded-full text-sm font-medium">
          ...
          <div className="container-custom py-6">
            ...
            <div className="mt-4 grid grid-cols-1 lg:grid-cols-[1.6fr,1fr] gap-4">
              ...
              <div className="rounded-2xl bg-thailand-blue-50 p-5">
                <p className="text-sm font-semibold text-thailand-blue-900 mb-2">
                  {t("Editorial review", "Redactionele beoordeling")}
                </p>
                <p className="text-sm text-thailand-blue-900">
                  {t("Last reviewed:", "Laatst beoordeeld:")}{" "}
                  <strong>{REVIEWED_DATE}</strong>
                </p>
                <p className="mt-2 text-sm text-thailand-blue-800">
                  {t("Reviewed by", "Beoordeeld door")}{" "}
                  <strong>Go2Thailand Editorial Team</strong>.{" "}
                  {t(
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  {
                    title: t(
                      "Avoid airport SIM friction",
                      "Vermijd SIM-gedoe op het vliegveld",
                    ),
                    text: t(
                  ...
                  <div
                    key={item.title}
                    className="rounded-2xl bg-surface-cream p-6 shadow-md"
                  >
                    <h3 className="font-semibold font-heading text-gray-900 mb-3">
                      {item.title}
                    </h3>
            ...
            <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-md">
              ...
              <h2 className="text-3xl font-bold font-heading text-gray-900 mb-4">
                {t(
                  ...
                  "Hoe we Thailand eSIM aanbieders vergeleken",
                )}
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {(locale === "nl"
                  ? methodologyPoints.nl
                  : methodologyPoints.en
                ).map((item) => (
                  <div
                    key={item}
                    className="rounded-xl bg-thailand-blue-50 p-4 text-sm text-thailand-blue-900"
                  >
            ...
            <div className="mx-auto max-w-4xl rounded-2xl bg-surface-cream p-8 shadow-md">
              ...
              <h2 className="text-3xl font-bold font-heading text-gray-900 mb-4">
                {t(
                  ...
                  "Wanneer eSIM niet automatisch de beste keuze is",
                )}
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="rounded-xl bg-white p-5">
                  <p className="font-semibold text-gray-900 mb-2">
                    {t(
                      "Airport SIM can still be simpler if",
                      "Vliegveld-SIM kan nog steeds eenvoudiger zijn als",
                    )}
                  </p>
                ...
                <div className="rounded-xl bg-white p-5">
                  <p className="font-semibold text-gray-900 mb-2">
                    {t("What we are not claiming", "Wat we niet beweren")}
                  </p>
                  <p className="text-gray-600">
                    {t(
                  ...
                  <div className="p-6">
                    <div className="relative mb-5 flex h-9 w-32 items-center">
                      {provider.logo ? (
                        ...
                        <span
                          className="font-heading text-2xl font-bold tracking-tight text-thailand-blue"
                    ...
                    <p className="text-sm font-semibold text-thailand-blue mb-2">
                      {provider.bestFor}
                    </p>
                    ...
                    <div className="rounded-xl bg-surface-cream p-4 mb-5">
                      <h4 className="font-semibold text-gray-900 mb-3">
                        {t(
                          `Sample plans checked ${REVIEWED_DATE}`,
                          `Voorbeeldbundels gecontroleerd ${REVIEWED_DATE}`,
                        )}
                      </h4>
                      <div className="space-y-2">
                        {provider.plans.map((plan) => (
                          <div
                            key={`${provider.slug}-${plan.label}`}
                    ...
                    <div className="grid grid-cols-1 gap-4 mb-6">
                      ...
                      <div>
                        <h4 className="font-semibold text-orange-700 mb-2">
                          {t("What to watch", "Waar op te letten")}
                        </h4>
                        <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <div className="mt-5 border-t border-gray-200 pt-4">
                      <p className="text-sm font-semibold text-gray-900 mb-3">
                        {t(
                          ...
                          "Officiële bronnen gecontroleerd tijdens beoordeling",
                        )}
                      </p>
                ...
                <div className="bg-thailand-blue-50 p-6">
                  <p className="font-semibold text-thailand-blue-900 mb-2">
                    {t(
                      ...
                      "Belangrijke opmerking over prijzen",
                    )}
                  </p>
                  <p className="text-sm text-thailand-blue-900">
                    {t(
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <h2 className="text-3xl font-bold font-heading text-gray-900 mb-8 text-center">
                {t(
                  ...
                  "Hoe installeer je je Thailand eSIM",
                )}
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                  ...
                  },
                  {
                    step: "2",
                    title: t(
                      "Buy with Wi-Fi available",
                      "Koop met Wi-Fi beschikbaar",
                    ),
                    text: t(
                  ...
                  },
                  {
                    step: "4",
                    title: t(
                      "Enable the line in Thailand",
                      "Activeer de lijn in Thailand",
                    ),
                    text: t(
                  ...
                  <div
                    key={item.step}
                    className="text-center rounded-2xl bg-surface-cream p-6 shadow-md"
                  >
            ...
            <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-md">
              ...
              <h2 className="text-3xl font-bold font-heading text-gray-900 mb-4">
                {t(
                  ...
                  "Bronnen, methodologie en transparantie",
                )}
              </h2>
              <p className="text-gray-600 mb-6">
                {t(`This page was reviewed on`, `Deze pagina is beoordeeld op`)}{" "}
                <strong>{REVIEWED_DATE}</strong>.{" "}
                {t(
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="rounded-2xl bg-thailand-blue-50 p-5">
                  ...
                  <p className="text-sm text-thailand-blue-900 mb-3">
                    {t("Reviewed by", "Beoordeeld door")}{" "}
                    <strong>Go2Thailand Editorial Team</strong> {t("on", "op")}{" "}
                    <strong>{REVIEWED_DATE}</strong>.
                  </p>
                  <p className="font-semibold text-thailand-blue-900 mb-2">
                    {t("Editorial standards", "Redactionele standaarden")}
                  </p>
                  <p className="text-sm text-thailand-blue-900">
                    {t(
                ...
                <div className="rounded-2xl bg-orange-50 p-5">
                  <p className="font-semibold text-orange-900 mb-2">
                    {t("Policy links", "Beleidslinks")}
                  </p>
                  <div className="space-y-2 text-sm">
                    <Link
                      href="/editorial-policy/"
                      className="block text-orange-900 underline underline-offset-2"
                    >
        ...
        <section className="section-padding">
          <div className="container-custom">
            <p className="section-label text-center">
              {t("Related Guides", "Gerelateerde Gidsen")}
            </p>
            <h2 className="text-3xl font-bold font-heading text-gray-900 mb-8 text-center">
              {t(
                "Related Thailand prep guides",
                "Gerelateerde Thailand voorbereidingsgidsen",
              )}
            </h2>
  ...
  const providers: ESIMProvider[] = [
    {
      ...
      bestFor:
        "Good fit if you want a familiar eSIM marketplace and several Thailand package sizes.",
      description:
      ...
      sourceLinks: [
        ...
        {
          label: "Airalo top-up help",
          href: "https://www.airalo.com/help/using-managing-esims/ZSEEHBT5HW6F/how-can-i-top-up-an-esim/2DMCF3341SYF",
        },
      ],
    },
    {
      ...
      bestFor:
        "Worth a look if you want unlimited-plan choices or more app-led flexibility.",
      description:
      ...
      sourceLinks: [
        ...
        {
          label: "Yesim setup help",
          href: "https://help.yesim.tech/yesim-esim-setup/",
        },
        {
          label: "Yesim contacts / support",
    ...
    },
    {
      ...
      bestFor:
        "Useful if you want straightforward data-only travel eSIM plans plus built-in privacy features.",
      description:
      ...
      sourceLinks: [
        ...
        {
          label: "Saily app setup steps",
          href: "https://saily.com/esim-thailand/",
        },
        {
          label: "Apple travel eSIM support",
          href: "https://support.apple.com/en-us/118227",
        },
      ],
    },
