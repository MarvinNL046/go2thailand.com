      ...
      <div className="min-h-screen bg-surface-cream">
        ...
        <section className="bg-surface-cream section-padding">
          <div className="container-custom text-center">
            <h2 className="text-2xl font-heading font-bold text-gray-900 mb-3">Pair with Thai Cuisine</h2>
            <p className="text-gray-600 mb-6">Explore the authentic Thai dishes that go perfectly with these traditional beverages.</p>
