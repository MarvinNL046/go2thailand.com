      ...
      <div className="min-h-screen bg-surface-cream">
        ...
        <section className="relative py-16 bg-surface-dark">
          <div className="container-custom text-center text-white">
            <FadeInText>
              <p className="font-script text-thailand-gold mb-2">Browse by Type</p>
        ...
        <section className="py-12 bg-white">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="text-3xl font-heading font-bold mb-4">Thai Beverage Culture</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-surface-cream p-6 rounded-2xl shadow-md">
                  ...
                  <h3 className="font-heading font-semibold mb-2">Climate Adapted</h3>
                ...
                <div className="bg-surface-cream p-6 rounded-2xl shadow-md">
                  <div className="text-2xl mb-2"></div>
                  <h3 className="font-heading font-semibold mb-2">Social Traditions</h3>
                  <p className="text-sm text-gray-600">
