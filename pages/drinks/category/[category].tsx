    ...
    <>
      ...
      <div className="min-h-screen bg-surface-cream">
        ...
        <section className="relative py-12 bg-surface-dark">
          <div className="container-custom text-center text-white">
            <FadeInText>
              ...
              <p className="font-script text-thailand-gold mb-2">Thai Beverages</p>
        ...
        <section className="section-padding">
          <div className="container-custom">
            <h2 className="text-2xl font-heading font-bold text-gray-900 mb-6 text-center">Explore Other Drink Categories</h2>
            <div className="flex flex-wrap gap-3 justify-center">
              {[
                { slug: 'tea', label: 'Thai Teas' },
                { slug: 'coffee', label: 'Thai Coffee' },
                { slug: 'alcohol', label: 'Beer & Spirits' },
                { slug: 'juice', label: 'Fresh Juices' },
                { slug: 'herbal', label: 'Herbal Drinks' },
                { slug: 'smoothie', label: 'Smoothies' },
                { slug: 'cocktail', label: 'Cocktails' },
        ...
        <section className="bg-white py-12">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              <p className="section-label font-script text-thailand-gold text-center">About</p>
              <h2 className="text-2xl font-heading font-bold mb-6 text-center">About {info.title}</h2>
