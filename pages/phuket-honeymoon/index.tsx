...
import PhuketRomanceVillaGuideNl from "../../components/romance/PhuketRomanceVillaGuideNl";
...
export default function PhuketHoneymoonPillar({
  partners,
  lastUpdated,
}: Props) {
  ...
  if (isNl) {
    return (
      <PhuketRomanceVillaGuideNl
        owner="honeymoon-hub"
        primaryUrl={partners.trip_honeymoon_resort.partnerUrl}
        secondaryUrl={partners.klook_honeymoon.partnerUrl}
      />
    );
  }
        ...
        <section className="bg-thailand-blue text-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <p className="mt-4 text-sm font-semibold uppercase tracking-wide text-white/75">
              {isNl ? "Phuket honeymoon-gids" : "Phuket honeymoon guide"}
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href={withSubId(
                  partners.trip_luxury_honeymoon.partnerUrl,
                  placement("hero-trip"),
                )}
                target="_blank"
              ...
              >
                {isNl
                  ? "Bekijk honeymoon-resorts op Trip.com"
                  : "See honeymoon resorts on Trip.com"}{" "}
                →
              </a>
              <a
                href={withSubId(
                  partners.trip_pool_villa.partnerUrl,
                  placement("hero-villa"),
                )}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
            ...
            <div className="mt-5 flex flex-wrap gap-x-5 gap-y-1 text-xs opacity-90">
              <span>
                ✔ 8 {isNl ? "resorts vergeleken" : "resorts compared"}
              </span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <section id="comparison">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-2">
              {isNl
                ? "8 honeymoon-resorts in Phuket vergeleken"
                : "8 Phuket honeymoon resorts compared"}
            </h2>
            <p className="text-gray-600 mb-6">
              {isNl
                ? "Klik om live tarieven en honeymoon-perks te zien (we verdienen een kleine commissie zonder dat het jou iets extra kost)."
                : "Click to see live rates and honeymoon perks (we earn a small commission at no extra cost to you)."}
            </p>
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    },
                    {
                      ...
                      area: "Pansea Beach",
                      style: isNl
                        ? "Iconic luxe, privé strand"
                        : "Iconic luxury, private beach",
                      price: "$1,500–4,500",
                    },
                    {
                      name: "Sri Panwa",
                    ...
                    },
                    {
                      ...
                      area: "Bang Tao",
                      style: isNl
                        ? "Lagune-villa, spa-resort"
                        : "Lagoon villa, spa resort",
                      price: "$500–1,800",
                    },
                    {
                      name: "The Slate",
                      area: "Nai Yang",
                      style: isNl
                        ? "Boutique tin-mine design"
                        : "Boutique tin-mine design",
                      price: "$300–700",
                    },
                    {
                      name: "JW Marriott Mai Khao",
                      area: "Mai Khao",
                      style: isNl
                        ? "Resort-stijl, lange beach"
                        : "Resort-style, long beach",
                      price: "$350–800",
                    },
                    {
                      name: "Anantara Mai Khao",
                      area: "Mai Khao",
                      style: isNl ? "Pool-villa, rustig" : "Pool villa, quiet",
                      price: "$450–1,200",
                    },
                    {
                      name: "Andara Resort",
                      area: "Kamala",
                      style: isNl
                        ? "Privé-villa takeover"
                        : "Private villa takeover",
                      price: "$800–2,800",
                    },
                  ].map((r, i) => (
                    <tr key={i} className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-semibold text-gray-900">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer nofollow sponsored"
                          className="text-thailand-blue hover:text-thailand-red hover:underline"
                        >
                          {r.name}
                        </a>
                      </td>
          ...
          <section className="rounded-2xl bg-thailand-red/5 border-2 border-thailand-red p-6">
            <span className="inline-block rounded-full bg-thailand-red text-white text-xs font-bold uppercase tracking-wide px-3 py-1 mb-3">
              ⭐ {isNl ? "Beste keuze voor de meesten" : "Top pick for most"}
            </span>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-3">
              {isNl
                ? "Trisara — pool-villa met privé strand-toegang"
                : "Trisara — pool villa with private beach access"}
            </h2>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                {isNl
                  ? "Bekijk Trisara op Trip.com"
                  : "See Trisara on Trip.com"}{" "}
                →
              </a>
              <a
                href={withSubId(
                  partners.trip_pool_villa.partnerUrl,
                  placement("toppick-villa"),
                )}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
          ...
          <section>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "4 honeymoon-gebieden in Phuket — welke past?"
                : "4 honeymoon areas in Phuket — which fits?"}
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-pink-500">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  {isNl ? "💕 Surin & Pansea" : "💕 Surin & Pansea"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? 'Het meest "honeymoon" gebied. Trisara, Amanpuri, The Surin allemaal in een 5km strook. Privé-stranden, walkable boutique restaurants, golden-hour magie. Beste voor eerste-keer-Phuket honeymooners.'
                    : 'The most "honeymoon" area. Trisara, Amanpuri, The Surin all within a 5km stretch. Private beaches, walkable boutique restaurants, golden-hour magic. Best for first-time-Phuket honeymooners.'}
                </p>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-blue-500">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  {isNl ? "🏖️ Bang Tao & Layan" : "🏖️ Bang Tao & Layan"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Grootste resort-keuze (Banyan Tree, JW Marriott, Outrigger Laguna). Lagune-villas met privé eilandjes, brede prijsrange ($300–1.800/nacht). Iets minder afgesloten dan Surin maar veel restaurant-opties."
                    : "Biggest resort selection (Banyan Tree, JW Marriott, Outrigger Laguna). Lagoon villas with private islets, wide price range ($300–1,800/night). Slightly less secluded than Surin but many restaurant options."}
                </p>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-green-500">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  {isNl ? "🌅 Mai Khao" : "🌅 Mai Khao"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Rustigste gebied — 11 km onbebouwd strand grenzend aan Sirinat National Park. Anantara, Renaissance, JW Marriott. Voor stellen die zero crowds willen + bereid zijn 25 min naar Phuket Town te rijden voor uit-eten."
                    : "Quietest area — 11 km of undeveloped beach next to Sirinat National Park. Anantara, Renaissance, JW Marriott. For couples who want zero crowds + are willing to drive 25 min to Phuket Town for dining out."}
                </p>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-amber-500">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  {isNl
                    ? "🌇 Cape Panwa & Cape Yamu"
                    : "🌇 Cape Panwa & Cape Yamu"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Sunset-cliffside aan oostkust — Sri Panwa, Cape Yamu. Korte rit (15 min) naar Phuket Town voor Old Town strolling. Beste voor stellen die luxe + nightlife/cultuur balans willen, niet pure isolation."
                    : "Sunset cliffside east coast — Sri Panwa, Cape Yamu. Short drive (15 min) to Phuket Town for Old Town strolling. Best for couples wanting luxury + nightlife/culture balance, not pure isolation."}
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "5 romantische activiteiten — vooraf boeken"
                : "5 romantic activities — book ahead"}
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-2xl bg-white p-5 shadow-sm border border-gray-100">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  🌅 {isNl ? "Sunset cruise voor 2" : "Sunset cruise for 2"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed mb-3">
                  {isNl
                    ? "Privé-catamaran of motorjacht 2,5 uur, lemong-grass cocktails, lichte tapas-style maaltijd. Vertrek 16:30 vanuit Yacht Haven of Royal Phuket Marina. $200–600 privé voor 2 — perfect honeymoon-night. Of $40–80 pp gedeeld."
                    : "Private catamaran or motor yacht for 2.5 hours, lemongrass cocktails, light tapas-style meal. Departs 16:30 from Yacht Haven or Royal Phuket Marina. $200–600 private for 2 — perfect honeymoon-night activity. Or $40–80 pp shared."}
                </p>
                <a
                  href={withSubId(
                    partners.klook_sunset_couples.partnerUrl,
                    placement("activity-sunset"),
                  )}
                  target="_blank"
                  rel="noopener noreferrer nofollow sponsored"
                  className="inline-flex items-center text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl
                    ? "Boek sunset cruise op Klook →"
                    : "Book sunset cruise on Klook →"}
                </a>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border border-gray-100">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  💆 {isNl ? "Couples spa-dag" : "Couples spa day"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed mb-3">
                  {isNl
                    ? "Banyan Tree Spa, COMO Shambhala, Trisara Jiva — alle drie 2,5–4u packages voor stellen ($250–800 voor 2). Inclusief ritueel-bad, massage, gezichtsbehandeling, fruit + thee. Boek 7–14 dagen vooruit voor weekenden."
                    : "Banyan Tree Spa, COMO Shambhala, Trisara Jiva — all three 2.5–4h couples packages ($250–800 for 2). Includes ritual bath, massage, facial, fruit + tea. Book 7–14 days ahead for weekends."}
                </p>
                <a
                  href={withSubId(
                    partners.klook_couples_spa.partnerUrl,
                    placement("activity-spa"),
                  )}
                  target="_blank"
                  rel="noopener noreferrer nofollow sponsored"
                  className="inline-flex items-center text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl
                    ? "Boek couples spa op Klook →"
                    : "Book couples spa on Klook →"}
                </a>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border border-gray-100">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  🏝️{" "}
                  {isNl
                    ? "Privé Phi Phi day-charter"
                    : "Private Phi Phi day charter"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed mb-3">
                  {isNl
                    ? "Eigen boot voor 2 — Maya Bay zonder de massa, Pileh Lagoon snorkelen, lunch in een stille baai. $500–1.200 voor het hele jacht (privé voor 2 gasten gevoelt extreem speciaal). Vroeg vertrek (07:00) vermijdt de toeristen-floods."
                    : "Your own boat for 2 — Maya Bay without crowds, Pileh Lagoon snorkeling, lunch in a quiet cove. $500–1,200 for the whole yacht (private for 2 feels extreme special). Early departure (07:00) avoids the tourist flood."}
                </p>
                <a
                  href={withSubId(
                    partners.klook_phi_phi_private.partnerUrl,
                    placement("activity-phi-phi"),
                  )}
                  target="_blank"
                  rel="noopener noreferrer nofollow sponsored"
                  className="inline-flex items-center text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl
                    ? "Boek privé Phi Phi tour →"
                    : "Book private Phi Phi tour →"}
                </a>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border border-gray-100">
                <h3 className="font-heading text-lg font-bold text-gray-900 mb-2">
                  🍷{" "}
                  {isNl ? "Romantisch dineren" : "Romantic dining experiences"}
                </h3>
                <p className="text-gray-700 text-sm leading-relaxed mb-3">
                  {isNl
                    ? "Baba Nest (Sri Panwa) sunset rooftop cocktails. PRU (Trisara) — Phuket's enige Michelin-ster restaurant. Mom Tri's Kitchen (Kata) — cliffside fine-dining. Reserveer 5–10 dagen vooruit voor weekend-tafels."
                    : "Baba Nest (Sri Panwa) sunset rooftop cocktails. PRU (Trisara) — Phuket's only Michelin-starred restaurant. Mom Tri's Kitchen (Kata) — cliffside fine dining. Reserve 5–10 days ahead for weekend tables."}
                </p>
                <a
                  href={withSubId(
                    partners.gyg_phuket_romantic.partnerUrl,
                    placement("activity-dining"),
                  )}
                  target="_blank"
                  rel="noopener noreferrer nofollow sponsored"
                  className="inline-flex items-center text-sm font-semibold text-thailand-red hover:underline"
                >
                  {isNl
                    ? "Romantisch dineren op GYG →"
                    : "Romantic dining on GYG →"}
                </a>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-2xl bg-amber-50 border border-amber-200 p-6">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "Boekingstips voor je Phuket-honeymoon"
                : "Booking tips for your Phuket honeymoon"}
            </h2>
            <ul className="space-y-3 text-gray-800">
              <li className="flex gap-3">
                ...
                <span>
                  <strong>
                    {isNl
                      ? 'Vermeld "honeymoon" bij élke boeking'
                      : 'Mention "honeymoon" on every booking'}
                  </strong>
                  {isNl
                    ? ". Resorts geven gratis upgrades, champagne, bloemen, late check-out. Je betaalt nooit extra."
                    : ". Resorts give free upgrades, champagne, flowers, late check-out. Never an extra cost."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
              ...
              <li className="flex gap-3">
                ...
                <span>
                  <strong>
                    {isNl
                      ? "Vergelijk pakket vs los boeken"
                      : "Compare package vs separate"}
                  </strong>
                  {isNl
                    ? ": all-inclusive scheelt $30–50/pp/dag bij meer dan 5 nachten — maar beperkt restaurant-keuze. Voor foodies: los boeken wint."
                    : ": all-inclusive saves $30–50/pp/day past 5 nights — but limits restaurant variety. For foodies: separate wins."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Activiteiten 2 weken vooruit boeken"
                      : "Book activities 2 weeks ahead"}
                  </strong>
                  {isNl
                    ? ": sunset cruise privé, couples spa, privé Phi Phi-charter — high-demand voor weekenden in hoogseizoen."
                    : ": private sunset cruise, couples spa, private Phi Phi charter — high demand on high-season weekends."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Verdeel je verblijf 4+3 of 5+2"
                      : "Split stay 4+3 or 5+2"}
                  </strong>
                  {isNl
                    ? ". Eerste deel rustig en luxe (Mai Khao/Trisara), tweede deel in Krabi/Phi Phi voor adventure-side. Voorkomt resort-saaiheid."
                    : ". First half quiet luxury (Mai Khao/Trisara), second half in Krabi/Phi Phi for the adventure side. Prevents resort fatigue."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? 'Reisverzekering met "trip cancel" niveau'
                      : "Trip-cancel level travel insurance"}
                  </strong>
                  {isNl
                    ? ": honeymoons zijn high-cost, hoge schade bij ziekte. Premium verzekering kost 5–8% van trip-budget."
                    : ": honeymoons are high cost with big losses on illness. Premium insurance costs 5–8% of trip budget."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Plan een sunset op dag 1"
                      : "Plan a sunset on day 1"}
                  </strong>
                  {isNl
                    ? "— niet wachten tot dag 5. Honeymoon-momentum begint bij eerste-avond Promthep Cape, Baba Nest of Cape Sienna sky bar."
                    : "— don't wait until day 5. Honeymoon momentum starts on day 1 with Promthep Cape, Baba Nest or Cape Sienna sky bar."}
                </span>
              </li>
            </ul>
          </section>
          ...
          <section className="rounded-2xl bg-thailand-blue/10 p-6">
            <h2 className="font-heading text-xl font-bold text-gray-900">
              {isNl
                ? "Plan de rest van je Phuket honeymoon"
                : "Plan the rest of your Phuket honeymoon"}
            </h2>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link
                href="/phuket-honeymoon/private-pool-villas/"
                className="rounded-full bg-thailand-red text-white px-5 py-2 text-sm font-semibold hover:bg-red-700"
              >
                {isNl ? "🏊 Privé pool-villas" : "🏊 Private pool villas"}
              </Link>
              <Link
                href="/phuket-honeymoon/all-inclusive/"
                className="rounded-full bg-thailand-red text-white px-5 py-2 text-sm font-semibold hover:bg-red-700"
              >
                {isNl
              ...
              <a
                ...
                className="rounded-full bg-thailand-red text-white px-5 py-2 text-sm font-semibold hover:bg-red-700"
              >
                {isNl ? "🎟️ Honeymoon-activiteiten" : "🎟️ Honeymoon activities"}
              </a>
            </div>
          </section>
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  return {
    props: { partners: data.partners, lastUpdated: data.lastUpdated },
    revalidate: 604800,
  };
};
