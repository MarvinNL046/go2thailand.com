          ...
          <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-md p-8">
            ...
            <div className="prose prose-lg max-w-none">
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">1. Acceptance of Terms</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">2. Use of Website</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">3. Content Disclaimer</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">4. Intellectual Property</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">5. Third-Party Links</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">6. Advertising</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">7. Limitation of Liability</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">8. Indemnification</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">9. Changes to Terms</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">10. Governing Law</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold font-heading mb-4">11. Contact Information</h2>
                <p className="mb-4">
