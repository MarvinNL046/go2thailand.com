            ...
            <section id="regions" className="mb-16">
              ...
              <div className="mb-10">
                <div className="bg-white rounded-2xl shadow-md p-6 border-l-4 border-thailand-blue">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-3">
                    This is the most important piece of weather information for Thailand trip planning, and the one most travelers get wrong. The Gulf coast &mdash; <Link href="/city/koh-samui/" className="text-thailand-blue hover:underline">{t("s017_koh_samui")}</Link>, <Link href="/islands/koh-phangan/" className="text-thailand-blue hover:underline">{t("s018_koh_phangan")}</Link>, and <Link href="/islands/koh-tao/" className="text-thailand-blue hover:underline">Koh Tao</Link> &mdash; operates on the northeast monsoon, which is the opposite pattern to the Andaman coast. The Gulf islands are driest from May to September, precisely when the Andaman coast is wettest.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <section id="festivals" className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl shadow-md p-6">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    The legendary all-night beach party on Haad Rin, <Link href="/islands/koh-phangan/" className="text-thailand-blue hover:underline">{t("s018_koh_phangan")}</Link>, happens monthly around the full moon. Expect fire dancers, neon body paint, booming music, and bucket cocktails on the sand. The entrance fee is &#3647;200. The party runs year-round regardless of season, though the biggest crowds come during high season months (December&ndash;February). Check exact dates before booking, as they sometimes shift to avoid Buddhist holidays.
                  </p>
                </div>
              </div>
            </section>
