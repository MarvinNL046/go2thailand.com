              ...
              <div className="mb-6">
                ...
                <div className="bg-red-50 rounded-xl p-5 border border-red-100">
                  <ul className="space-y-3 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-red-500 font-bold mt-0.5">!</span>
                      <span><strong>{isNl ? 'Koh Samui resorts:' : 'Koh Samui resorts:'}</strong> {isNl ? 'Koh Samui heeft zich gepositioneerd als een luxe bestemming, en de resortgebieden Chaweng en Bophut weerspiegelen dit met premiumprijzen. Budgetreizigers kunnen overleven door te verblijven in het minder ontwikkelde zuiden van het eiland of in Nathon-stad, maar het eiland is over het geheel genomen 30-40% duurder dan de buureilanden Koh Phangan en Koh Tao.' : 'Koh Samui has positioned itself as an upscale destination, and the resort areas of Chaweng and Bophut reflect this with premium pricing. Budget travelers can survive by staying in the less-developed south of the island or in Nathon town, but the island overall is 30-40% more expensive than its neighbors Koh Phangan and Koh Tao.'}</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-500 font-bold mt-0.5">!</span>
                      <span><strong>{isNl ? 'Bangkok Sukhumvit luxezone:' : 'Bangkok Sukhumvit luxury zone:'}</strong> {isNl ? 'Het gebied rond de lage Sukhumvit (Nana tot Phrom Phong) is de meest internationale en duurste buurt van Bangkok. Restaurants, bars en hotels hier richten zich op expats en zakenreizigers tegen prijzen ruim boven het Bangkokse gemiddelde. Budgetreizigers kunnen beter verblijven in het Khao San Road-gebied, Silom of aan de overkant van de rivier in Thonburi voor veel betere prijzen, met nog steeds gemakkelijke BTS/MRT-toegang tot de rest van de stad.' : 'The area around lower Sukhumvit (Nana to Phrom Phong) is Bangkok&apos;s most international and expensive neighborhood. Restaurants, bars, and hotels here cater to expats and business travelers at prices well above the Bangkok average. Budget travelers should base themselves in the Khao San Road area, Silom, or across the river in Thonburi for much better value while still having easy BTS/MRT access to the rest of the city.'}</span>
                    </li>
                  </ul>
                </div>
              </div>
