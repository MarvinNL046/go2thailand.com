        ...
        <section className="bg-thailand-blue text-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <h1 className="font-heading text-3xl lg:text-5xl font-bold mt-4">
              {/* H1 deliberately differs from metaTitle per SEO playbook —
                  uses 'Top N picks' framing + secondary keyword 'where to stay'. */}
              Top {data.hotels.length} {categoryLabel} hotels in {data.cityName}: Where to stay in 2026
            </h1>
