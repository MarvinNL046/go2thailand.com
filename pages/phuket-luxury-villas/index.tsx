...
export default function PhuketLuxuryVillasPillar({
  partners,
  lastUpdated,
}: Props) {
        ...
        <section className="bg-thailand-blue text-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <p className="mt-4 text-sm font-semibold uppercase tracking-wide text-white/75">
              {isNl ? "Phuket luxe villa-gids" : "Phuket luxury villa guide"}
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href={withSubId(
                  partners.trip_luxury.partnerUrl,
              ...
              >
                {isNl
                  ? "Bekijk Phuket luxe villa's op Trip.com"
                  : "See Phuket luxury villas on Trip.com"}{" "}
                →
              </a>
              <a
                href={withSubId(
            ...
            <div className="mt-5 flex flex-wrap gap-x-5 gap-y-1 text-xs opacity-90">
              ...
              <span>
                ✔ {isNl ? "Per gebied + categorie" : "By area + category"}
              </span>
              <span>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
          ...
          <section id="comparison">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-2">
              {isNl
                ? "Snelle vergelijking: 8 luxe villa-resorts"
                : "Quick comparison: 8 luxury villa resorts"}
            </h2>
            <p className="text-gray-600 mb-6">
              {isNl
                ? "Klik op een resort om actuele beschikbaarheid te zien (we verdienen een kleine commissie zonder dat het jou iets extra kost)."
                : "Click a resort to see live availability (we earn a small commission at no extra cost to you)."}
            </p>
                  ...
                  {[
                    {
                      name: "Amanpuri",
                      area: "Pansea",
                      type: isNl ? "Privé estate" : "Private estate",
                      price: "$5,000–15,000",
                      best: isNl ? "Ultieme prestige" : "Ultimate prestige",
                    },
                    {
                      name: "Trisara",
                      area: "Layan",
                      type: isNl ? "Oceanfront pool" : "Oceanfront pool",
                      price: "$2,500–9,000",
                      best: isNl
                        ? "Honeymoons, privacy"
                        : "Honeymoons, privacy",
                    },
                    {
                      name: "Sri Panwa",
                      area: "Cape Panwa",
                      type: isNl ? "Cliff pool villa" : "Cliff pool villa",
                      price: "$1,200–4,500",
                      best: isNl ? "Uitzicht, sociaal" : "Views, social",
                    },
                    {
                      name: "Banyan Tree Phuket",
                      area: "Bang Tao",
                      type: isNl ? "Lagoon pool" : "Lagoon pool",
                      price: "$800–2,500",
                      best: isNl ? "Best value luxe" : "Best value luxury",
                    },
                    {
                      name: "Andara Resort & Villas",
                      area: "Kamala",
                      type: isNl ? "Hillside pool" : "Hillside pool",
                      price: "$1,200–2,500",
                      best: isNl ? "Families 4+ gasten" : "Families 4+ guests",
                    },
                    {
                      name: "The Pavilions Phuket",
                      area: "Cherng Talay",
                      type: isNl ? "Adults-only pool" : "Adults-only pool",
                      price: "$700–1,400",
                      best: isNl
                        ? "Stellen, budget-luxe"
                    ...
                    },
                    {
                      ...
                      area: "Kamala",
                      type: isNl ? "Pool villa" : "Pool villa",
                      price: "$600–1,200",
                      best: isNl ? "Foodies, panorama" : "Foodies, panorama",
                    },
                    {
                      name: "Twinpalms Montazure",
                      area: "Kamala",
                      type: isNl ? "Beach pool villa" : "Beach pool villa",
                      price: "$900–2,200",
                      best: isNl ? "Beachfront, design" : "Beachfront, design",
                    },
                  ].map((r, i) => (
          ...
          <section className="rounded-2xl bg-thailand-red/5 border-2 border-thailand-red p-6">
            ...
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-3">
              {isNl
                ? "Banyan Tree Phuket — beste value luxe pool villa"
                : "Banyan Tree Phuket — best value luxury pool villa"}
            </h2>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                href={withSubId(
                  BOOKING_GENERIC,
                  placementSubId("toppick-booking"),
                )}
                target="_blank"
                rel="noopener noreferrer nofollow sponsored"
          ...
          <section>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "Welk gebied van Phuket past bij jouw villa-trip?"
                : "Which area of Phuket fits your villa trip?"}
            </h2>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-green-500">
                ...
                <p className="text-xs text-green-700 font-semibold mb-2">
                  {isNl ? "👍 Beste mix" : "👍 Best mix"}
                </p>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Noordwestkust, breed plat strand, 25 min van de luchthaven. Trisara, Banyan Tree, The Pavilions. Family-friendly, Laguna golf-resort vlakbij. Beste keuze voor 5–7 daagse villa-trip."
                    : "North-west coast, wide flat beach, 25 min from airport. Trisara, Banyan Tree, The Pavilions. Family-friendly, Laguna golf resort nearby. Best choice for a 5–7 day villa trip."}
                </p>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-blue-500">
                ...
                <p className="text-xs text-blue-700 font-semibold mb-2">
                  {isNl ? "🔵 Prestige + privacy" : "🔵 Prestige + privacy"}
                </p>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Noordwest, dichter bij Patong (15 min). Amanpuri, Andara, Twinpalms Montazure, Cape Sienna. Prive coves, beste zonsondergangen, fine-dining scene. Voor honeymoons en discrete luxe."
                    : "North-west, closer to Patong (15 min). Amanpuri, Andara, Twinpalms Montazure, Cape Sienna. Private coves, best sunsets, fine-dining scene. For honeymoons and discreet luxury."}
                </p>
              </div>
              <div className="rounded-2xl bg-white p-5 shadow-sm border-l-4 border-amber-500">
                ...
                <p className="text-xs text-amber-700 font-semibold mb-2">
                  {isNl ? "🌅 Sunrise + harbour" : "🌅 Sunrise + harbour"}
                </p>
                <p className="text-gray-700 text-sm leading-relaxed">
                  {isNl
                    ? "Zuidoostkust, kalme havenzijde, 15 min naar Phuket Town. Sri Panwa cliff-villa's, Baba Nest sunset bar. Ander gevoel — minder strand, meer cliff-pool drama. Beste voor stellen die zonsopgang willen."
                    : "South-east coast, calm harbour side, 15 min to Phuket Town. Sri Panwa cliff villas, Baba Nest sunset bar. Different vibe — less beach, more cliff-pool drama. Best for couples wanting sunrise."}
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-2xl bg-amber-50 border border-amber-200 p-6">
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "Boekingstips voor luxe villa's in Phuket"
                : "Booking tips for luxury villas in Phuket"}
            </h2>
            <ul className="space-y-3 text-gray-800">
              <li className="flex gap-3">
                ...
                <span>
                  <strong>
                    {isNl
                      ? "Boek hoogseizoen 2–4 maanden vooruit"
                      : "Book high season 2–4 months ahead"}
                  </strong>
                  {isNl
                    ? ". Top villa's gaan 3–6 maanden vooruit op slot voor Kerst en Chinees Nieuwjaar — laat is laat."
                    : ". Top villas sell out 3–6 months ahead for Christmas and Chinese New Year — late is late."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  ...
                  {isNl
                    ? ". Een 3-bedroom villa is vaak maar 60% duurder dan 1-bedroom — per slaapkamer bespaar je significant. Multi-generation trips zijn de bedoeling op dit niveau."
                    : ". A 3-bedroom is often only 60% more than a 1-bedroom — per-bedroom you save big. Multi-generation trips are intended at this tier."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Direct boeken loont voor 5+ nachten"
                      : "Direct booking pays for 5+ nights"}
                  </strong>
                  {isNl
                    ? ". Vraag late check-out, gratis luchthaventransfer, ontbijt voor 2, of $200 spa-credit. Resort-managers willen direct-bookers."
                    : ". Ask for late checkout, complimentary airport transfer, breakfast for 2, or $200 spa credit. Resort managers prefer direct bookers."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? 'Bevestig "private pool exclusive use"'
                      : 'Confirm "private pool, exclusive use"'}
                  </strong>
                  {isNl
                    ? '. Onder $600/nacht kan "pool villa" gedeeld zwembad betekenen. Op luxe-niveau zou het exclusief moeten zijn — eis dit in de bevestiging.'
                    : '. Below $600/night, "pool villa" can mean shared pool. At the luxury tier it should be exclusive — get it in the booking confirmation.'}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  ...
                  {isNl
                    ? ". Standaard 10% service + 7% btw bovenop kamerprijs. Check of de quote inclusief is — rekenkundig 17% verschil per nacht."
                    : ". Standard 10% service + 7% VAT on top of room rate. Check if the quote includes both — that's 17% per night."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Vergelijk altijd 3 platforms"
                      : "Always compare 3 platforms"}
                  </strong>
                  {isNl
                    ? ": Trip.com en Booking.com hebben vaak 10–25% prijsverschil voor identieke villa, identieke datum. Klein werk, grote winst."
                    : ": Trip.com and Booking.com often differ 10–25% for identical villa, identical date. Small effort, big saving."}
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-amber-700 font-bold">→</span>
                <span>
                  <strong>
                    {isNl
                      ? "Reisverzekering met villa-coverage"
                      : "Travel insurance with villa coverage"}
                  </strong>
                  {isNl
                    ? '. Op $1.500+/nacht is annuleringsverzekering essentieel. Specifieke "villa cancellation" polis kost 2–4% van totaalprijs — sterk aangeraden.'
                    : '. At $1,500+/night, cancellation insurance is essential. Specific "villa cancellation" policy costs 2–4% of total — strongly recommended.'}
                </span>
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "Top luxe villa-resorts in detail"
                : "Top luxury villa resorts in detail"}
            </h2>
            <div className="space-y-5">
              {[
                ...
                >
                  ...
                  >
                    {isNl
                      ? `Bekijk ${r.name} op Trip.com →`
                      : `See ${r.name} on Trip.com →`}
                  </a>
                </div>
              ))}
            </div>
          ...
          <section>
            <h2 className="font-heading text-2xl font-bold text-gray-900 mb-4">
              {isNl
                ? "Verken specifieke villa-types"
                : "Explore specific villa types"}
            </h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
              <Link
                href="/phuket-luxury-villas/private-pool/"
              ...
              >
                <p className="font-heading font-bold text-gray-900">
                  {isNl ? "Private pool villa's" : "Private pool villas"}
                </p>
                <p className="text-sm text-gray-600 mt-1">
                  {isNl
                    ? "Elke kamer eigen pool, $800–10.000/nacht"
                    : "Every room with private pool, $800–10,000/night"}
                </p>
              ...
              >
                <p className="font-heading font-bold text-gray-900">
                  {isNl ? "Oceanfront villa's" : "Oceanfront villas"}
                </p>
                <p className="text-sm text-gray-600 mt-1">
                  {isNl
                    ? "Direct uitzicht op zee, vanaf $1.500/nacht"
              ...
              >
                <p className="font-heading font-bold text-gray-900">
                  {isNl
                    ? "Family villa's (4+ slaapkamers)"
                    : "Family villas (4+ bedrooms)"}
                </p>
                <p className="text-sm text-gray-600 mt-1">
                  {isNl
                    ? "Multi-gen trips, eigen chef + butler"
                    : "Multi-gen trips, own chef + butler"}
                </p>
                <p className="text-xs text-thailand-blue mt-2 font-semibold">
                  {isNl ? "Bekijk gids" : "See guide"} →
                </p>
              ...
              >
                <p className="font-heading font-bold text-gray-900">
                  {isNl
                    ? "Private pool villa Phuket vergelijking"
                    : "Private pool villa Phuket comparison"}
                </p>
                <p className="text-sm text-gray-600 mt-1">
                  {isNl
                    ? "Wat verwachten + beste operators"
                    : "What to expect + best operators"}
                </p>
                <p className="text-xs text-thailand-blue mt-2 font-semibold">
                  {isNl ? "Bekijk gids" : "See guide"} →
                </p>
          ...
          <section className="rounded-2xl bg-thailand-blue/10 p-6">
            ...
            <p className="mt-2 text-gray-700">
              {isNl
                ? "Villa is geboekt — werk de rest af:"
