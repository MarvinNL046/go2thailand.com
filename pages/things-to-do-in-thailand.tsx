  ...
  return (
    <>
      <SEOHead
        ...
        description={t("s001_the_25_best_things")}
      >
            ...
            <section id="temples" className="mb-16">
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s002_explore_bangkok_apos_s")}</h3>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s003_entrance_fee")}</strong> ฿500 (includes Wat Phra Kaew, Coin Pavilion, and Queen Sirikit Museum of Textiles)</p>
                      <p><strong>Hours:</strong> 8:30am - 4:30pm daily (ticket office closes at 3:30pm)</p>
                      <p><strong>Tip:</strong> {t("s004_go_first_thing_in")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/bangkok/" className="text-thailand-blue hover:underline font-semibold">{t("s005_explore_our_full_bangkok")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s006_watch_sunrise_at_ayutthaya")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s003_entrance_fee")}</strong> ฿50 per temple (or ฿220 for a six-temple combo ticket)</p>
                      <p><strong>Hours:</strong> {t("s008_most_temples_open_8am")}</p>
                      <p><strong>Tip:</strong> {t("s009_take_the_early_morning")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/ayutthaya/" className="text-thailand-blue hover:underline font-semibold">{t("s010_read_our_ayutthaya_destination")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s011_climb_1_256_steps")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s003_entrance_fee")}</strong> {t("s013_free_donations_welcome")}</p>
                      <p><strong>Hours:</strong> 6am - 6pm daily</p>
                      <p><strong>Tip:</strong> {t("s014_start_before_8am_to")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/krabi/" className="text-thailand-blue hover:underline font-semibold">{t("s015_explore_our_full_krabi")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s016_visit_the_white_temple")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s003_entrance_fee")}</strong> ฿200 for foreigners (doubled January 2026); free for Thais</p>
                      <p><strong>Hours:</strong> 8am - 5pm daily (grounds open 6:30am - 6pm)</p>
                      <p><strong>Tip:</strong> {t("s018_visit_early_morning_when")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/chiang-rai/" className="text-thailand-blue hover:underline font-semibold">{t("s019_explore_chiang_rai")}</Link>
                      {' '}<span className="text-gray-400">|</span>{' '}
                      <Link href="/blog/chiang-rai-white-temple-entrance-fee-doubles-2026/" className="text-thailand-blue hover:underline font-semibold">{t("s020_read_about_the_2026")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s021_discover_doi_suthep_in")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s003_entrance_fee")}</strong> ฿30 for foreigners</p>
                      <p><strong>Hours:</strong> 6am - 8pm daily</p>
                      <p><strong>Tip:</strong> {t("s023_the_309_steps_are")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/chiang-mai/" className="text-thailand-blue hover:underline font-semibold">{t("s024_explore_our_full_chiang")}</Link>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="beaches" className="mb-16">
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s025_island_hop_in_the")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s026_best_season")}</strong> {t("s027_november_april_andaman_coast")}</p>
                      <p><strong>{t("s028_day_trip_cost")}</strong> ฿800-1,500 per person for group tours including lunch</p>
                      <p><strong>Tip:</strong> {t("s029_book_a_private_longtail")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/krabi/" className="text-thailand-blue hover:underline font-semibold">{t("s030_explore_our_krabi_guide")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s031_relax_on_phuket_apos")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s032_best_beaches_for_families")}</strong> {t("s033_kata_karon_nai_harn")}</p>
                      <p><strong>{t("s034_best_for_nightlife")}</strong> Patong</p>
                      <p><strong>Tip:</strong> {t("s035_rent_a_scooter_200")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/phuket/" className="text-thailand-blue hover:underline font-semibold">{t("s036_explore_phuket")}</Link>
                      {' '}<span className="text-gray-400">|</span>{' '}
                      <Link href="/phuket-beaches/" className="text-thailand-blue hover:underline font-semibold">{t("s037_phuket_beach_guide")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s038_experience_koh_lanta_apos")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s026_best_season")}</strong> {t("s040_november_april")}</p>
                      <p><strong>{t("s041_getting_there")}</strong> {t("s042_ferry_from_krabi_1")}</p>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s045_dive_or_snorkel_at")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s046_best_diving_season")}</strong> {t("s047_march_october_calmest_seas")}</p>
                      <p><strong>{t("s048_padi_open_water_course")}</strong> ฿9,000-11,000 (3-4 days, often includes accommodation)</p>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s052_party_at_the_full")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s003_entrance_fee")}</strong> ฿200</p>
                      <p><strong>When:</strong> {t("s054_monthly_around_the_full")}</p>
            ...
            <section id="food" className="mb-16">
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s057_take_a_thai_cooking")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      ...
                      <p><strong>Duration:</strong> {t("s058_half_day_3_4")}</p>
                      <p><strong>Tip:</strong> {t("s059_book_a_class_early")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/chiang-mai/" className="text-thailand-blue hover:underline font-semibold">{t("s060_explore_chiang_mai")}</Link>
                      {' '}<span className="text-gray-400">|</span>{' '}
                      <Link href="/best-cooking-classes-in-thailand/" className="text-thailand-blue hover:underline font-semibold">{t("s061_best_cooking_classes_in")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s062_eat_your_way_through")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s063_budget_per_meal")}</strong> ฿40-80 per dish at street stalls</p>
                      <p><strong>{t("s064_top_areas")}</strong> {t("s065_yaowarat_chinatown_victory_monument")}</p>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s069_visit_a_floating_market")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                      {isNl
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s070_damnoen_saduak")}</strong> {isNl ? 'Dagelijks, best voor 9 uur — circa 1,5 uur vanaf Bangkok' : 'Daily, best before 9am — about 1.5 hours from Bangkok'}</p>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s071_try_authentic_pad_thai")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      ...
                      <p><strong>Hours:</strong> {t("s072_approximately_5pm_midnight_closed")}</p>
            ...
            <section id="nature" className="mb-16">
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s075_ethical_elephant_experience_in")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      ...
                      <p><strong>Duration:</strong> {t("s076_half_day_4_5")}</p>
                      <p><strong>Tip:</strong> {t("s077_avoid_any_place_that")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/best-elephant-sanctuaries-in-thailand/" className="text-thailand-blue hover:underline font-semibold">{t("s078_best_elephant_sanctuaries_in")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s079_hike_to_viewpoints_in")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s041_getting_there")}</strong> {t("s081_minivan_from_chiang_mai")}</p>
                      <p><strong>{t("s026_best_season")}</strong> {t("s083_november_february_cool_misty")}</p>
                      <p><strong>Tip:</strong> {t("s084_spend_at_least_2")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/pai/" className="text-thailand-blue hover:underline font-semibold">{t("s085_explore_our_pai_guide")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s086_rock_climb_at_railay")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s087_beginner_course")}</strong> ฿1,000-1,800 for half-day including gear and instructor</p>
                      <p><strong>{t("s088_number_of_routes")}</strong> 700+ bolted routes across all grades</p>
                      <p><strong>Tip:</strong> {t("s089_stay_on_railay_itself")}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s090_kayak_through_phang_nga")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s028_day_trip_cost")}</strong> ฿1,500-3,500 per person from Phuket including lunch</p>
                      <p><strong>Highlights:</strong> {t("s092_james_bond_island_hidden")}</p>
                      <p><strong>Tip:</strong> {t("s093_book_a_kayaking_tour")}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s094_trek_through_khao_sok")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s095_park_entrance_fee")}</strong> ฿300 for foreigners</p>
                      <p><strong>Rafthouses:</strong> ฿1,500-3,000/night including meals and guided activities</p>
                      <p><strong>Tip:</strong> {t("s096_book_a_2_day")}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section id="culture" className="mb-16">
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s097_learn_muay_thai_in")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s098_drop_in_session")}</strong> ฿300-800 per session (1.5-2 hours)</p>
                      <p><strong>{t("s099_stadium_fights")}</strong> ฿1,000-2,000 ringside at Rajadamnern or Lumpinee</p>
                      <p><strong>Tip:</strong> {t("s100_even_if_you_have")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/best-muay-thai-in-thailand/" className="text-thailand-blue hover:underline font-semibold">{t("s101_best_muay_thai_gyms")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s102_release_a_sky_lantern")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>When:</strong> {t("s103_november_exact_dates_vary")}</p>
                      <p><strong>{t("s104_organized_event_tickets")}</strong> ฿3,000-5,000 per person (book months ahead)</p>
                      <p><strong>Tip:</strong> {t("s105_book_accommodation_in_chiang")}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s106_get_a_traditional_thai")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      ...
                      <p><strong>Tip:</strong> {t("s107_communicate_with_your_therapist")}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s108_explore_bangkok_apos_s")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>Hours:</strong> {t("s109_saturday_sunday_9am_6pm")}</p>
                      <p><strong>Size:</strong> 15,000+ stalls across 27 sections</p>
                      <p><strong>Tip:</strong> {t("s110_bring_cash_in_small")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/blog/chatuchak-market-bangkok-guide/" className="text-thailand-blue hover:underline font-semibold">{t("s111_our_full_chatuchak_market")}</Link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s112_stay_in_a_treehouse")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      ...
                      <p><strong>{t("s113_what_to_bring")}</strong> {t("s114_headlamp_insect_repellent_dry")}</p>
                      <p><strong>Tip:</strong> {t("s115_book_a_2_night")}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold font-heading text-gray-900 mb-2">{t("s116_visit_sukhothai_historical_park")}</h3>
                    <p className="text-gray-700 leading-relaxed mb-3">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600 space-y-1">
                      <p><strong>{t("s003_entrance_fee")}</strong> ฿100 per zone (central zone is the must-see; ฿350 combo ticket for all zones)</p>
                      <p><strong>Hours:</strong> 6:30am - 7:30pm daily (central zone); other zones 6am - 6pm</p>
                      <p><strong>Tip:</strong> {t("s118_rent_a_bicycle_30")}</p>
                    </div>
                    <p className="mt-3 text-sm">
                      <Link href="/city/sukhothai/" className="text-thailand-blue hover:underline font-semibold">{t("s119_explore_our_sukhothai_guide")}</Link>
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div key={item.question}>
                      ...
                      {item.question === 'How many days do you need in Thailand?' && (
                        <p className="mt-2 text-sm">
                          <Link href="/thailand-itinerary/" className="text-thailand-blue hover:underline font-semibold">{t("s120_browse_our_thailand_itineraries")}</Link>
                        </p>
                      )}
                      ...
                      {item.question === 'Do you need a visa for Thailand?' && (
                        <p className="mt-2 text-sm">
                          <Link href="/visa/" className="text-thailand-blue hover:underline font-semibold">{t("s122_full_thailand_visa_guide")}</Link>
                        </p>
                      )}
                      {item.question === 'Is Thailand safe for tourists?' && (
                        <p className="mt-2 text-sm">
                          <Link href="/is-thailand-safe/" className="text-thailand-blue hover:underline font-semibold">{t("s123_full_thailand_safety_guide")}</Link>
                        </p>
                      )}
