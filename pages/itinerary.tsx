            ...
            <section id="3-4-week" className="mb-16">
              ...
              <div className="bg-white rounded-2xl shadow-md p-6 mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    <strong>{t("s097_days_16_19_island")}</strong> {t("s098_ferry_to_the_islands")} <Link href="/islands/koh-phangan/" className="text-thailand-blue hover:underline font-semibold">{t("s041_koh_phangan")}</Link> (yoga, beaches, optional Full Moon Party) and two nights on <Link href="/islands/koh-tao/" className="text-thailand-blue hover:underline font-semibold">Koh Tao</Link> (diving and snorkeling).
                  </p>
                  <p className="text-gray-700 leading-relaxed">
