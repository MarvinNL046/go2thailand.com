...
function generateSitemap() {
  ...
  // Only EN has full content for all dynamic pages.
  // Non-EN locales only get: static pages + their own translated blog posts.
