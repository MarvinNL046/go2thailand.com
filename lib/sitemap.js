...
function generateSitemap() {
  ...
  console.log(`📊 Data loaded: ${cities.length} cities, ${dishes.length} dishes, ${drinks.length} drinks, ${attractions.length} attractions, ${top10Guides.length} top-10 guides, ${regions.length} regions, ${islands.length} islands, ${visas.length} visas, ${practicalInfo.length} practical-info, ${blogPosts.length} blog posts`);
