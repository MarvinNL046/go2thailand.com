...
const { convertFoodDataSafely } = require('./convert-food-data-safe');

// Function to convert CSV to individual JSON files
function convertFoodData() {
  // Use the safe version that preserves enhanced data
  console.log('🛡️ Using safe conversion method to preserve enhanced content...');
  return convertFoodDataSafely();
}

// Old implementation (kept for reference but not used)
function convertFoodDataOld() {
  const dishes = [];
