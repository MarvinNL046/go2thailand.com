...
for (const proof of ['bangkokCityFoodEn', 'chiangMaiCityFoodEn', 'pattayaCityFoodEn', 'phuketCityFoodEn', "'chiang-mai': chiangMaiCityFoodEn", 'pattaya: pattayaCityFoodEn', 'phuket: phuketCityFoodEn', 'getEnCityFoodGuide']) {
