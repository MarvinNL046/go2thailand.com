...
const buengKanCityFoodNl = read('data/city-food/nl/bueng-kan.ts');
...
const chiangKhanCityFoodNl = read('data/city-food/nl/chiang-khan.ts');
const nongKhaiCityFoodNl = read('data/city-food/nl/nong-khai.ts');
...
const phitsanulokCityFoodNl = read('data/city-food/nl/phitsanulok.ts');
const phuketCityFoodNl = read('data/city-food/nl/phuket.ts');
const rayongCityFoodNl = read('data/city-food/nl/rayong.ts');
...
for (const proof of ['formats:', 'districts:', 'dishes:', 'dayPlan:', 'practicalChecks:', 'phrases:', 'faqs:', 'sources:', 'simple-thai-food-cookbook', 'thai-granite-mortar-eight-inch']) {
  ...
  if (!chiangKhanCityFoodNl.includes(proof)) failures.push(`Dutch Chiang Khan city-food owner lacks content proof: ${proof}`);
  if (!nongKhaiCityFoodNl.includes(proof)) failures.push(`Dutch Nong Khai city-food owner lacks content proof: ${proof}`);
  ...
  if (!huaHinCityFoodNl.includes(proof)) failures.push(`Dutch Hua Hin city-food owner lacks content proof: ${proof}`);
  ...
  if (!kanchanaburiCityFoodNl.includes(proof)) failures.push(`Dutch Kanchanaburi city-food owner lacks content proof: ${proof}`);
  if (!kohSamuiCityFoodNl.includes(proof)) failures.push(`Dutch Koh Samui city-food owner lacks content proof: ${proof}`);
  if (!lampangCityFoodNl.includes(proof)) failures.push(`Dutch Lampang city-food owner lacks content proof: ${proof}`);
  if (!lopburiCityFoodNl.includes(proof)) failures.push(`Dutch Lopburi city-food owner lacks content proof: ${proof}`);
  if (!maeHongSonCityFoodNl.includes(proof)) failures.push(`Dutch Mae Hong Son city-food owner lacks content proof: ${proof}`);
  if (!nakhonRatchasimaCityFoodNl.includes(proof)) failures.push(`Dutch Nakhon Ratchasima city-food owner lacks content proof: ${proof}`);
  if (!nakhonSiThammaratCityFoodNl.includes(proof)) failures.push(`Dutch Nakhon Si Thammarat city-food owner lacks content proof: ${proof}`);
  ...
  if (!phitsanulokCityFoodNl.includes(proof)) failures.push(`Dutch Phitsanulok city-food owner lacks content proof: ${proof}`);
  if (!phuketCityFoodNl.includes(proof)) failures.push(`Dutch Phuket city-food owner lacks content proof: ${proof}`);
  if (!rayongCityFoodNl.includes(proof)) failures.push(`Dutch Rayong city-food owner lacks content proof: ${proof}`);
...
for (const proof of ['chiangKhanCityFoodNl', "'chiang-khan': chiangKhanCityFoodNl"]) {
  if (!cityFoodRegistryNl.includes(proof)) failures.push(`Dutch city-food registry lacks Chiang Khan owner proof: ${proof}`);
}
for (const proof of ['nongKhaiCityFoodNl', "'nong-khai': nongKhaiCityFoodNl"]) {
  if (!cityFoodRegistryNl.includes(proof)) failures.push(`Dutch city-food registry lacks Nong Khai owner proof: ${proof}`);
}
for (const proof of ['buengKanCityFoodNl', "'bueng-kan': buengKanCityFoodNl"]) {
  if (!cityFoodRegistryNl.includes(proof)) failures.push(`Dutch city-food registry lacks Bueng Kan owner proof: ${proof}`);
}
...
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/chiang-khan/food/'", 'chiang-khan-food-mekong-dawn-nl.webp']) {
  if (!chiangKhanCityFoodNl.includes(proof)) failures.push(`Dutch Chiang Khan city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/nong-khai/food/'", 'nong-khai-food-mekong-sunrise-nl.webp']) {
  if (!nongKhaiCityFoodNl.includes(proof)) failures.push(`Dutch Nong Khai city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/bueng-kan/food/'", 'bueng-kan-food-mekong-morning-nl.webp']) {
  if (!buengKanCityFoodNl.includes(proof)) failures.push(`Dutch Bueng Kan city-food owner lacks locale or asset proof: ${proof}`);
}
...
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/kanchanaburi/food/'", 'kanchanaburi-food-river-table-nl.webp']) {
  if (!kanchanaburiCityFoodNl.includes(proof)) failures.push(`Dutch Kanchanaburi city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/koh-samui/food/'", 'koh-samui-food-working-coast-coconut-nl.webp']) {
  if (!kohSamuiCityFoodNl.includes(proof)) failures.push(`Dutch Koh Samui city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/hua-hin/food/'", 'hua-hin-food-khao-takiab-nl.webp']) {
  if (!huaHinCityFoodNl.includes(proof)) failures.push(`Dutch Hua Hin city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/lopburi/food/'", 'lopburi-food-palace-market-nl.webp']) {
  if (!lopburiCityFoodNl.includes(proof)) failures.push(`Dutch Lopburi city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/phitsanulok/food/'", 'phitsanulok-food-nan-river-nl.webp']) {
  if (!phitsanulokCityFoodNl.includes(proof)) failures.push(`Dutch Phitsanulok city-food owner lacks locale or asset proof: ${proof}`);
}
...
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/ubon-ratchathani/food/'", 'ubon-ratchathani-food-ho-trai-nl.webp']) {
  if (!ubonRatchathaniCityFoodNl.includes(proof)) failures.push(`Dutch Ubon Ratchathani city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/nakhon-ratchasima/food/'", 'korat-food-chum-phon-pad-mee-nl.webp']) {
  if (!nakhonRatchasimaCityFoodNl.includes(proof)) failures.push(`Dutch Nakhon Ratchasima city-food owner lacks locale or asset proof: ${proof}`);
}
for (const proof of ["locale: 'nl'", "pageUrl: 'https://go2-thailand.com/nl/city/nakhon-si-thammarat/food/'", 'nakhon-si-thammarat-food-khanom-jeen-morning-nl.webp']) {
  if (!nakhonSiThammaratCityFoodNl.includes(proof)) failures.push(`Dutch Nakhon Si Thammarat city-food owner lacks locale or asset proof: ${proof}`);
}
...
const kohLantaIslandData = read('data/islands/nl-guides/koh-lanta.ts');
for (const proof of ['kohLantaIslandGuide', "breadcrumbsRoot: { label: 'Eilanden'", 'Department of National Parks Thailand', 'koh-lanta-island-hero-nl.webp']) {
  if (!kohLantaIslandData.includes(proof)) failures.push(`Koh Lanta island owner lacks proof: ${proof}`);
}
...
const kohLipeIslandData = read('data/islands/nl-guides/koh-lipe.ts');
for (const proof of ['kohLipeIslandGuide', "breadcrumbsRoot: { label: 'Eilanden'", 'Department of National Parks Thailand', 'koh-lipe-island-hero-nl.webp']) {
  if (!kohLipeIslandData.includes(proof)) failures.push(`Koh Lipe island owner lacks proof: ${proof}`);
}
...
const kohMakIslandData = read('data/islands/nl-guides/koh-mak.ts');
for (const proof of ['kohMakIslandGuide', "breadcrumbsRoot: { label: 'Eilanden'", 'Thai Meteorological Department', 'koh-mak-island-hero-nl.webp']) {
  if (!kohMakIslandData.includes(proof)) failures.push(`NL Koh Mak island owner missing proof: ${proof}`);
}
...
const nlTravelGuideDirectory = read('components/editorial/TravelGuideDirectoryNl.tsx');
const travelGuideDirectoryRoute = read('pages/travel-guides/index.tsx');
for (const proof of ['EditorialHero', 'PageSectionNav', 'RelatedGuidesSection', 'SourceMethodSection', 'data-premium-template="travel-guide-directory-nl"', 'CollectionPage', 'ItemList']) {
  if (!nlTravelGuideDirectory.includes(proof)) failures.push(`NL travel-guide directory lacks proof: ${proof}`);
}
