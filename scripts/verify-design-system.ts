...
for (const proof of ['krabiCityFoodNl', 'krabi: krabiCityFoodNl']) {
  if (!cityFoodRegistryNl.includes(proof)) failures.push(`Dutch city-food registry lacks Krabi owner proof: ${proof}`);
}
